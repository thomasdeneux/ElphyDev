...
{$ENDIF}
  ...
  public
    ...
    procedure DisplayString( const str : AnsiString );
...
begin
  ...
  begin
    st := '';
    InputQuery( 'Query for Python', 'Enter text', st);
    result:=st;
  end;
end;
...
procedure TPythonGUIInputOutput.DisplayString( const str : AnsiString );
begin

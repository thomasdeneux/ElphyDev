...
{$ENDIF}
  ...
  public
    ...
    {** Given a member name, returns its DispID. Here, if a pythonObject is attached,
        this method will return the address of the requested member name AnsiString (in fact,
...
procedure DebugMessageFmt(s : AnsiString; args : Array of Const);
begin
...
var
  ...
  lParam : PVariant;
  myVariant: Variant;
  {$IFDEF DEBUG}lFlags : AnsiString;{$ENDIF}
begin
  with GetPythonEngine do
    begin
      result := S_OK;

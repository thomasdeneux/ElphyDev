...
type
  ...
  private
    ...
    FColumnNames: array of AnsiString;
  ...
  public
    ...
    function GetColumnName(ColumnIndex: Integer): AnsiString;
...
function TZRowAccessor.GetColumnName(ColumnIndex: Integer): AnsiString;
begin
 CheckColumnIndex(ColumnIndex);

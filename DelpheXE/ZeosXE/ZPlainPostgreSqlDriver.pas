...
function TZPostgreSQL7PlainDriver.GetProtocol: AnsiString;
begin
  Result := 'postgresql-7';
end;

function TZPostgreSQL7PlainDriver.GetDescription: AnsiString;
begin
...
function TZPostgreSQL8PlainDriver.GetProtocol: AnsiString;
begin
  Result := 'postgresql-8';
end;

function TZPostgreSQL8PlainDriver.GetDescription: AnsiString;
begin

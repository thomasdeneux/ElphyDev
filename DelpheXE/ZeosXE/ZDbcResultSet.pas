...
type
  ...
  protected
    ...
    function GetColumnIndex(const ColumnName: AnsiString): Integer;
  ...
  public
    constructor Create(Statement: IZStatement; SQL: AnsiString;
    ...
    function IsNullByName(const ColumnName: AnsiString): Boolean; virtual;
    function GetPCharByName(const ColumnName: AnsiString): PAnsiChar; virtual;
    function GetStringByName(const ColumnName: AnsiString): AnsiString; virtual;
    function GetUnicodeStringByName(const ColumnName: AnsiString): WideString; virtual;
    function GetBooleanByName(const ColumnName: AnsiString): Boolean; virtual;
    function GetByteByName(const ColumnName: AnsiString): ShortInt; virtual;
    function GetShortByName(const ColumnName: AnsiString): SmallInt; virtual;
    function GetIntByName(const ColumnName: AnsiString): Integer; virtual;
    function GetLongByName(const ColumnName: AnsiString): Int64; virtual;
    function GetFloatByName(const ColumnName: AnsiString): Single; virtual;
    function GetDoubleByName(const ColumnName: AnsiString): Double; virtual;
    function GetBigDecimalByName(const ColumnName: AnsiString): Extended; virtual;
    function GetBytesByName(const ColumnName: AnsiString): TByteDynArray; virtual;
    function GetDateByName(const ColumnName: AnsiString): TDateTime; virtual;
    function GetTimeByName(const ColumnName: AnsiString): TDateTime; virtual;
    function GetTimestampByName(const ColumnName: AnsiString): TDateTime; virtual;
    function GetAsciiStreamByName(const ColumnName: AnsiString): TStream; virtual;
    function GetUnicodeStreamByName(const ColumnName: AnsiString): TStream; virtual;
    function GetBinaryStreamByName(const ColumnName: AnsiString): TStream; virtual;
    function GetBlobByName(const ColumnName: AnsiString): IZBlob; virtual;
    function GetValueByName(const ColumnName: AnsiString): TZVariant; virtual;
    ...
    function FindColumn(const ColumnName: AnsiString): Integer; virtual;
    ...
    procedure UpdateNullByName(const ColumnName: AnsiString); virtual;
    procedure UpdateBooleanByName(const ColumnName: AnsiString; Value: Boolean); virtual;
    procedure UpdateByteByName(const ColumnName: AnsiString; Value: ShortInt); virtual;
    procedure UpdateShortByName(const ColumnName: AnsiString; Value: SmallInt); virtual;
    procedure UpdateIntByName(const ColumnName: AnsiString; Value: Integer); virtual;
    procedure UpdateLongByName(const ColumnName: AnsiString; Value: Int64); virtual;
    procedure UpdateFloatByName(const ColumnName: AnsiString; Value: Single); virtual;
    procedure UpdateDoubleByName(const ColumnName: AnsiString; Value: Double); virtual;
    procedure UpdateBigDecimalByName(const ColumnName: AnsiString; Value: Extended); virtual;
    procedure UpdatePCharByName(const ColumnName: AnsiString; Value: PAnsiChar); virtual;
    procedure UpdateStringByName(const ColumnName: AnsiString; const Value: AnsiString); virtual;
    procedure UpdateUnicodeStringByName(const ColumnName: AnsiString; const Value: WideString);
      virtual;
    procedure UpdateBytesByName(const ColumnName: AnsiString; const Value: TByteDynArray); virtual;
    procedure UpdateDateByName(const ColumnName: AnsiString; Value: TDateTime); virtual;
    procedure UpdateTimeByName(const ColumnName: AnsiString; Value: TDateTime); virtual;
    procedure UpdateTimestampByName(const ColumnName: AnsiString; Value: TDateTime); virtual;
    procedure UpdateAsciiStreamByName(const ColumnName: AnsiString; Value: TStream); virtual;
    procedure UpdateUnicodeStreamByName(const ColumnName: AnsiString; Value: TStream); virtual;
    procedure UpdateBinaryStreamByName(const ColumnName: AnsiString; Value: TStream); virtual;
    procedure UpdateValueByName(const ColumnName: AnsiString; const Value: TZVariant); virtual;

    procedure InsertRow; virtual;
    procedure UpdateRow; virtual;
    procedure UpdateRowGS(keys:AnsiString); virtual;
...
constructor TZAbstractResultSet.Create(Statement: IZStatement; SQL: AnsiString;
  Metadata: TContainedObject);
var
...
{**
  ...
  suitable for retrieving large <AnsiChar>LONGVARCHAR</AnsiChar> values.
...
function TZAbstractResultSet.IsNullByName(const ColumnName: AnsiString): Boolean;
begin
...
function TZAbstractResultSet.GetPCharByName(const ColumnName: AnsiString): PAnsiChar;
begin
...
function TZAbstractResultSet.GetStringByName(const ColumnName: AnsiString): AnsiString;
begin
...
function TZAbstractResultSet.GetUnicodeStringByName(const ColumnName: AnsiString):
  WideString;
begin
...
function TZAbstractResultSet.GetBooleanByName(const ColumnName: AnsiString): Boolean;
begin
...
function TZAbstractResultSet.GetByteByName(const ColumnName: AnsiString): ShortInt;
begin
...
function TZAbstractResultSet.GetShortByName(const ColumnName: AnsiString): SmallInt;
begin
...
function TZAbstractResultSet.GetIntByName(const ColumnName: AnsiString): Integer;
begin
...
function TZAbstractResultSet.GetLongByName(const ColumnName: AnsiString): Int64;
begin
...
function TZAbstractResultSet.GetFloatByName(const ColumnName: AnsiString): Single;
begin
...
function TZAbstractResultSet.GetDoubleByName(const ColumnName: AnsiString): Double;
begin
...
function TZAbstractResultSet.GetBigDecimalByName(const ColumnName: AnsiString): Extended;
begin
...
function TZAbstractResultSet.GetBytesByName(const ColumnName: AnsiString): TByteDynArray;
begin
...
function TZAbstractResultSet.GetDateByName(const ColumnName: AnsiString): TDateTime;
begin
...
function TZAbstractResultSet.GetTimeByName(const ColumnName: AnsiString): TDateTime;
begin
...
function TZAbstractResultSet.GetTimestampByName(const ColumnName: AnsiString): TDateTime;
begin
...
function TZAbstractResultSet.GetAsciiStreamByName(const ColumnName: AnsiString): TStream;
begin
...
function TZAbstractResultSet.GetUnicodeStreamByName(const ColumnName: AnsiString): TStream;
begin
...
function TZAbstractResultSet.GetBinaryStreamByName(const ColumnName: AnsiString): TStream;
begin
...
function TZAbstractResultSet.GetBlobByName(const ColumnName: AnsiString): IZBlob;
begin
...
function TZAbstractResultSet.GetValueByName(const ColumnName: AnsiString): TZVariant;
begin
...
function TZAbstractResultSet.GetColumnIndex(const ColumnName: AnsiString): Integer;
begin
...
function TZAbstractResultSet.FindColumn(const ColumnName: AnsiString): Integer;
var
  I: Integer;
  Metadata: TZAbstractResultSetMetadata;
begin
...
procedure TZAbstractResultSet.UpdateNullByName(const ColumnName: AnsiString);
begin
...
procedure TZAbstractResultSet.UpdateBooleanByName(const ColumnName: AnsiString;
  Value: Boolean);
begin
...
procedure TZAbstractResultSet.UpdateByteByName(const ColumnName: AnsiString;
  Value: ShortInt);
begin
...
procedure TZAbstractResultSet.UpdateShortByName(const ColumnName: AnsiString;
  Value: SmallInt);
begin
...
procedure TZAbstractResultSet.UpdateIntByName(const ColumnName: AnsiString;
  Value: Integer);
begin
...
procedure TZAbstractResultSet.UpdateLongByName(const ColumnName: AnsiString;
  Value: Int64);
begin
...
procedure TZAbstractResultSet.UpdateFloatByName(const ColumnName: AnsiString;
  Value: Single);
begin
...
procedure TZAbstractResultSet.UpdateDoubleByName(const ColumnName: AnsiString;
  Value: Double);
begin
...
procedure TZAbstractResultSet.UpdateBigDecimalByName(const ColumnName: AnsiString;
  Value: Extended);
begin
...
procedure TZAbstractResultSet.UpdatePCharByName(const ColumnName: AnsiString;
  Value: PAnsiChar);
begin
...
procedure TZAbstractResultSet.UpdateStringByName(const ColumnName: AnsiString;
...
procedure TZAbstractResultSet.UpdateUnicodeStringByName(const ColumnName: AnsiString;
  const Value: WideString);
begin
...
procedure TZAbstractResultSet.UpdateBytesByName(const ColumnName: AnsiString;
  const Value: TByteDynArray);
begin
...
procedure TZAbstractResultSet.UpdateDateByName(const ColumnName: AnsiString;
  Value: TDateTime);
begin
...
procedure TZAbstractResultSet.UpdateTimeByName(const ColumnName: AnsiString;
  Value: TDateTime);
begin
...
procedure TZAbstractResultSet.UpdateTimestampByName(const ColumnName: AnsiString;
  Value: TDateTime);
begin
...
procedure TZAbstractResultSet.UpdateAsciiStreamByName(const ColumnName: AnsiString;
  Value: TStream);
begin
...
procedure TZAbstractResultSet.UpdateBinaryStreamByName(const ColumnName: AnsiString;
  Value: TStream);
begin
...
procedure TZAbstractResultSet.UpdateUnicodeStreamByName(const ColumnName: AnsiString;
  Value: TStream);
begin
...
procedure TZAbstractResultSet.UpdateValueByName(const ColumnName: AnsiString;
  const Value: TZVariant);
begin
...
procedure TZAbstractResultSet.UpdateRowGS(keys:AnsiString);
begin
  RaiseReadOnlyException;
end;
...
{**
  ...
  @param Stream a data AnsiString object.
}
...
{**
  Gets the AnsiString from the stored data.
  @return a AnsiString which contains the stored data.
}
...
{**
  Sets a new AnsiString data to this blob content.
  @param Value a new AnsiString data.
}
...
{**
  Gets the wide AnsiString from the stored data.
  @return a AnsiString which contains the stored data.
}
...
{**
  Sets a new AnsiString data to this blob content.
  @param Value a new wide AnsiString data.
}

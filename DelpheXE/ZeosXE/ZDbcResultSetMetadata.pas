...
type
  ...
  public
    constructor Create;
    function GetColumnTypeName: AnsiString;
    ...
    property ColumnLabel: AnsiString read FColumnLabel write FColumnLabel;
    ...
    property CatalogName: AnsiString read FCatalogName write FCatalogName;
  ...
  protected
    ...
    function ReadColumnByName(FieldName: AnsiString; TableRef: TZTableRef;
      ColumnInfo: TZColumnInfo): Boolean;
  ...
  public
    constructor Create(Metadata: IZDatabaseMetadata; SQL: AnsiString;
    ...
    function GetColumnLabel(Column: Integer): AnsiString; virtual;
    function GetColumnName(Column: Integer): AnsiString; virtual;
    function GetSchemaName(Column: Integer): AnsiString; virtual;
    function GetPrecision(Column: Integer): Integer; virtual;
    function GetScale(Column: Integer): Integer; virtual;
    function GetTableName(Column: Integer): AnsiString; virtual;
    function GetCatalogName(Column: Integer): AnsiString; virtual;
    function GetColumnType(Column: Integer): TZSQLType; virtual;
    function GetColumnTypeName(Column: Integer): AnsiString; virtual;
    ...
    function GetDefaultValue(Column: Integer): AnsiString; virtual;
...
function TZColumnInfo.GetColumnTypeName: AnsiString;
begin
...
constructor TZAbstractResultSetMetadata.Create(Metadata: IZDatabaseMetadata;
  SQL: AnsiString; ParentResultSet: TZAbstractResultSet);
begin
...
function TZAbstractResultSetMetadata.GetColumnLabel(Column: Integer): AnsiString;
var
  I, J, N: Integer;
...
function TZAbstractResultSetMetadata.GetTableName(Column: Integer): AnsiString;
begin
  if not Loaded then LoadColumns;
...
function TZAbstractResultSetMetadata.GetCatalogName(Column: Integer): AnsiString;
begin
  if not Loaded then LoadColumns;
...
function TZAbstractResultSetMetadata.GetColumnTypeName(Column: Integer): AnsiString;
begin
...
begin
  if not Loaded then LoadColumns;
  // '' = NULL / no default value, '''''' = empty AnsiString (''), etc.
...
function TZAbstractResultSetMetadata.ReadColumnByName(FieldName: AnsiString;

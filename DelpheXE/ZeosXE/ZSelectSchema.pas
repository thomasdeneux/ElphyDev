...
type
  ...
  private
    ...
    FAlias: AnsiString;
  public
    constructor Create(const Catalog, Schema, Table, Alias: AnsiString);
    function FullName: AnsiString;

    property Catalog: AnsiString read FCatalog write FCatalog;
    property Schema: AnsiString read FSchema write FSchema;
  ...
  public
    constructor Create(IsField: Boolean; const Catalog, Schema, Table,
      Field, Alias: AnsiString; TableRef: TZTableRef);

    property IsField: Boolean read FIsField write FIsField;
    property Catalog: AnsiString read FCatalog write FCatalog;
    property Schema: AnsiString read FSchema write FSchema;
    property Table: AnsiString read FTable write FTable;
    property Field: AnsiString read FField write FField;
    property Alias: AnsiString read FAlias write FAlias;
  ...
  IZSelectSchema = interface (IZInterface)
    ...
    function FindTableByFullName(const Catalog, Schema, Table: AnsiString): TZTableRef;
    function FindTableByShortName(const Table: AnsiString): TZTableRef;
    function FindFieldByShortName(const Field: AnsiString): TZFieldRef;

    function LinkFieldByIndexAndShortName(
      ColumnIndex: Integer; const Field: AnsiString): TZFieldRef;
...
constructor TZTableRef.Create(const Catalog, Schema, Table, Alias: AnsiString);
begin
  FCatalog := Catalog;
  FSchema := Schema;
  FTable := Table;
...
function TZTableRef.FullName: AnsiString;
begin
...
function TZSelectSchema.FindTableByFullName(
  const Catalog, Schema, Table: AnsiString): TZTableRef;
var
  I: Integer;
  Current: TZTableRef;
begin
...
function TZSelectSchema.FindTableByShortName(const Table: AnsiString): TZTableRef;
var
  I: Integer;
  Current: TZTableRef;
begin
...
function TZSelectSchema.FindFieldByShortName(const Field: AnsiString): TZFieldRef;
var
  I: Integer;
  Current: TZFieldRef;
begin

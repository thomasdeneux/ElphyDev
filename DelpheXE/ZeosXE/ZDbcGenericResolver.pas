...
type
  ...
  public
    constructor Create(ColumnIndex: Integer; ColumnName: AnsiString;
      ColumnType: TZSQLType; NewValue: Boolean; DefaultValue: AnsiString);
  ...
  protected
    ...
    function ComposeFullTableName(Catalog, Schema, Table: AnsiString): AnsiString;
    function DefineTableName: AnsiString;
  ...
  public
    ...
    function FormWhereClause(Columns: TObjectList;
      OldRowAccessor: TZRowAccessor): AnsiString;
    function FormInsertStatement(Columns: TObjectList;
      NewRowAccessor: TZRowAccessor): AnsiString;
    function FormUpdateStatement(Columns: TObjectList;
      OldRowAccessor, NewRowAccessor: TZRowAccessor): AnsiString;
    function FormDeleteStatement(Columns: TObjectList;
      OldRowAccessor: TZRowAccessor): AnsiString;
    function FormCalculateStatement(Columns: TObjectList): AnsiString; virtual;
    ...
    procedure PostUpdatesGS(Sender: IZCachedResultSet;
      UpdateType: TZRowUpdateType;
      OldRowAccessor, NewRowAccessor: TZRowAccessor; keys:AnsiString); virtual;
...
constructor TZResolverParameter.Create(ColumnIndex: Integer;
  ColumnName: AnsiString; ColumnType: TZSQLType; NewValue: Boolean; DefaultValue: AnsiString);
begin
...
function TZGenericCachedResolver.DefineTableName: AnsiString;
var
  I: Integer;
  Temp: AnsiString;
begin
...
var
  ...
  Catalog, Schema, Table: AnsiString;
...
function TZGenericCachedResolver.FormCalculateStatement(
  Columns: TObjectList): AnsiString;
var
  I: Integer;
  Current: TZResolverParameter;
begin
...
procedure TZGenericCachedResolver.PostUpdatesGS(Sender: IZCachedResultSet;
  UpdateType: TZRowUpdateType; OldRowAccessor, NewRowAccessor: TZRowAccessor; keys:AnsiString);
var
  Statement            : IZPreparedStatement;
  SQL                  : AnsiString;
  SQLParams            : TObjectList;
...
begin
  ...
  try
    ...
    begin
      ...
      lUpdateCount := Statement.ExecuteUpdatePreparedGS(keys);
      if  (lValidateUpdateCount)
      and (lUpdateCount <> 1   ) then
        raise EZSQLException.Create(Format(SInvalidUpdateCount, [lUpdateCount]));
    end;

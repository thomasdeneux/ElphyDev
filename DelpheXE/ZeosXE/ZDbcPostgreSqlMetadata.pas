...
type
  ...
  protected
    ...
    function GetPostgreSQLType(Oid: Integer): AnsiString;
    function GetSQLTypeByOid(Oid: Integer): TZSQLType;
    function GetSQLTypeByName(TypeName: AnsiString): TZSQLType;
    function TableTypeSQLExpression(TableType: AnsiString; UseSchemas: Boolean):
      AnsiString;
    procedure ParseACLArray(List: TStrings; AclString: AnsiString);
    function GetPrivilegeName(Permission: AnsiChar): AnsiString;

    function UncachedGetTables(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString; const Types: TStringDynArray): IZResultSet; override;
    ...
    function UncachedGetColumns(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet; override;
    function UncachedGetTablePrivileges(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString): IZResultSet; override;
    function UncachedGetColumnPrivileges(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet; override;
    function UncachedGetPrimaryKeys(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): IZResultSet; override;
    ...
    function UncachedGetCrossReference(const PrimaryCatalog: AnsiString; const PrimarySchema: AnsiString;
      ...
      const ForeignTable: AnsiString): IZResultSet; override;
    function UncachedGetIndexInfo(const Catalog: AnsiString; const Schema: AnsiString; const Table: AnsiString;
     ...
     function UncachedGetSequences(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const SequenceNamePattern: AnsiString): IZResultSet; override;
    function UncachedGetProcedures(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const ProcedureNamePattern: AnsiString): IZResultSet; override;
...
//      const TypeNamePattern: AnsiString; const Types: TIntegerDynArray): IZResultSet; override;
  public
    constructor Create(Connection: TZAbstractConnection; Url: AnsiString;
      Info: TStrings);
    destructor Destroy; override;

    function GetDatabaseProductName: AnsiString; override;
    function GetDatabaseProductVersion: AnsiString; override;
    function GetDriverName: AnsiString; override;
    ...
    function GetSQLKeywords: AnsiString; override;
    function GetNumericFunctions: AnsiString; override;
    function GetStringFunctions: AnsiString; override;
    function GetSystemFunctions: AnsiString; override;
    function GetTimeDateFunctions: AnsiString; override;
    function GetSearchStringEscape: AnsiString; override;
    function GetExtraNameCharacters: AnsiString; override;
    ...
    function GetSchemaTerm: AnsiString; override;
    function GetProcedureTerm: AnsiString; override;
    function GetCatalogTerm: AnsiString; override;
    function GetCatalogSeparator: AnsiString; override;
...
{**
  @param S a AnsiString.
  @return escaped AnsiString
}
function TZPostgreSQLDatabaseMetadata.EscapeString(const S: AnsiString): AnsiString;
var
  I: Integer;
begin
  Result := S;
...
constructor TZPostgreSQLDatabaseMetadata.Create(
  Connection: TZAbstractConnection; Url: AnsiString; Info: TStrings);
var
  TempInfo: TStrings;
  Hostname, UserName, Password: AnsiString;
  Port: Integer;
begin
...
function TZPostgreSQLDatabaseMetadata.GetDatabaseProductName: AnsiString;
begin
  Result := 'PostgreSQL';
end;
...
function TZPostgreSQLDatabaseMetadata.GetDatabaseProductVersion: AnsiString;
begin
  Result := '';
end;
...
function TZPostgreSQLDatabaseMetadata.GetDriverName: AnsiString;
begin
...
function TZPostgreSQLDatabaseMetadata.GetSQLKeywords: AnsiString;
begin
...
function TZPostgreSQLDatabaseMetadata.GetNumericFunctions: AnsiString;
begin
  Result := '';
end;
...
function TZPostgreSQLDatabaseMetadata.GetStringFunctions: AnsiString;
begin
  Result := '';
end;
...
function TZPostgreSQLDatabaseMetadata.GetSystemFunctions: AnsiString;
begin
  Result := '';
end;
...
function TZPostgreSQLDatabaseMetadata.GetTimeDateFunctions: AnsiString;
begin
  Result := '';
end;
...
function TZPostgreSQLDatabaseMetadata.GetSearchStringEscape: AnsiString;
begin
  Result := '\';
end;
...
function TZPostgreSQLDatabaseMetadata.GetExtraNameCharacters: AnsiString;
begin
  Result := '';
end;
...
function TZPostgreSQLDatabaseMetadata.GetSchemaTerm: AnsiString;
begin
  Result := 'schema';
end;
...
function TZPostgreSQLDatabaseMetadata.GetProcedureTerm: AnsiString;
begin
  Result := 'function';
end;
...
function TZPostgreSQLDatabaseMetadata.GetCatalogTerm: AnsiString;
begin
  Result := 'database';
end;
...
function TZPostgreSQLDatabaseMetadata.GetCatalogSeparator: AnsiString;
begin
  Result := '.';
end;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetProcedures(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString): IZResultSet;
var
  SQL, LProcedureNamePattern: AnsiString;
begin
...
function TZPostgreSQLDatabaseMetadata.UncachedGetProcedureColumns(const Catalog: AnsiString;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetTables(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const Types: TStringDynArray): IZResultSet;
var
  I: Integer;
  TableType, OrderBy, SQL: AnsiString;
  UseSchemas: Boolean;
...
const
  Types: array [0..10] of AnsiString = ('TABLE', 'VIEW', 'INDEX',
...
{**
  ...
  <P>Each column description has the following columns:
   ...
   for a UDT the type name is fully qualified
 	<LI><B>COLUMN_SIZE</B> int => column size.  For AnsiChar or date
 	...
 	<LI><B>CHAR_OCTET_LENGTH</B> int => for AnsiChar types the
...
function TZPostgreSQLDatabaseMetadata.UncachedGetColumns(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): IZResultSet;
{const
  VARHDRSZ = 4;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetColumnPrivileges(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet;
var
  I, J: Integer;
  SQL, Column, Owner: AnsiString;
  Privileges, Grantable, Grantee: AnsiString;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetTablePrivileges(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString): IZResultSet;
var
  I, J: Integer;
  SQL, SchemaName, TableName, Owner: AnsiString;
  Privileges, Grantable, Grantee: AnsiString;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetVersionColumns(const Catalog: AnsiString;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetPrimaryKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
var
  SQL, Select, From, Where: AnsiString;
begin
    if HaveMinimumServerVersion(7, 3) then
    begin
...
function TZPostgreSQLDatabaseMetadata.UncachedGetImportedKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
begin
...
function TZPostgreSQLDatabaseMetadata.UncachedGetExportedKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
begin
  Result := UncachedGetCrossReference(Catalog, Schema, Table, '', '', '');
end;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetCrossReference(const PrimaryCatalog: AnsiString;
...
var
  SQL, Select, From, Where: AnsiString;
  DeleteRule, UpdateRule, Rule: AnsiString;
  {FKeyName, }FKeyColumn, PKeyColumn, Targs: AnsiString;
...
function TZPostgreSQLDatabaseMetadata.UncachedGetIndexInfo(const Catalog: AnsiString;
...
function TZPostgreSQLDatabaseMetadata.GetPostgreSQLType(Oid: Integer): AnsiString;
begin
...
function TZPostgreSQLDatabaseMetadata.TableTypeSQLExpression(
  TableType: AnsiString; UseSchemas: Boolean): AnsiString;
begin
  if UseSchemas then
  begin
...
procedure TZPostgreSQLDatabaseMetadata.ParseACLArray(
  List: TStrings; AclString: AnsiString);
var
  PrevChar: AnsiChar;
  InQuotes: Boolean;
...
function TZPostgreSQLDatabaseMetadata.GetPrivilegeName(Permission: AnsiChar): AnsiString;
begin
 case Permission of
   'a': Result := 'INSERT';
   'r': Result := 'SELECT';

...
type
  ...
  protected
    ...
    procedure PostRowUpdates(OldRowAccessor, NewRowAccessor: TZRowAccessor);
      override;
  public
    constructor CreateWithStatement(const SQL: AnsiString; Statement: IZStatement);
    constructor CreateWithColumns(ColumnsInfo: TObjectList; const SQL: AnsiString);
  ...
  protected
    ...
    procedure AddResultSetToCache(const Key: AnsiString; ResultSet: IZResultSet);
    function GetResultSetFromCache(const Key: AnsiString): IZResultSet;
  ...
  protected
    function UncachedGetTables(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString; const Types: TStringDynArray): IZResultSet; virtual;
    ...
    function UncachedGetColumns(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet; virtual;
    function UncachedGetTablePrivileges(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString): IZResultSet; virtual;
    function UncachedGetColumnPrivileges(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet; virtual;

    function UncachedGetPrimaryKeys(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): IZResultSet; virtual;
    function UncachedGetImportedKeys(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): IZResultSet; virtual;
    function UncachedGetExportedKeys(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): IZResultSet; virtual;
    function UncachedGetCrossReference(const PrimaryCatalog: AnsiString; const PrimarySchema: AnsiString;
      const PrimaryTable: AnsiString; const ForeignCatalog: AnsiString; const ForeignSchema: AnsiString;
      const ForeignTable: AnsiString): IZResultSet; virtual;
    function UncachedGetIndexInfo(const Catalog: AnsiString; const Schema: AnsiString; const Table: AnsiString;
      Unique: Boolean; Approximate: Boolean): IZResultSet; virtual;
    function UncachedGetSequences(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const SequenceNamePattern: AnsiString): IZResultSet; virtual;
    function UncachedGetProcedures(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const ProcedureNamePattern: AnsiString): IZResultSet; virtual;
    function UncachedGetProcedureColumns(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const ProcedureNamePattern: AnsiString; const ColumnNamePattern: AnsiString):
      IZResultSet; virtual;
    function UncachedGetBestRowIdentifier(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString; Scope: Integer; Nullable: Boolean): IZResultSet; virtual;
    function UncachedGetVersionColumns(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): IZResultSet; virtual;
    function UncachedGetTypeInfo: IZResultSet; virtual;
    function UncachedGetUDTs(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TypeNamePattern: AnsiString; const Types: TIntegerDynArray): IZResultSet; virtual;

  public
    constructor Create(ParentConnection: IZConnection;
      const Url: AnsiString; Info: TStrings);
    destructor Destroy; override;

    function AllProceduresAreCallable: Boolean; virtual;
    function AllTablesAreSelectable: Boolean; virtual;
    function GetURL: AnsiString; virtual;
    ...
    function GetDatabaseProductName: AnsiString; virtual;
    function GetDatabaseProductVersion: AnsiString; virtual;
    function GetDriverName: AnsiString; virtual;
    function GetDriverVersion: AnsiString; virtual;
    ...
    function GetIdentifierQuoteString: AnsiString; virtual;
    function GetSQLKeywords: AnsiString; virtual;
    function GetNumericFunctions: AnsiString; virtual;
    function GetStringFunctions: AnsiString; virtual;
    function GetSystemFunctions: AnsiString; virtual;
    function GetTimeDateFunctions: AnsiString; virtual;
    function GetSearchStringEscape: AnsiString; virtual;
    function GetExtraNameCharacters: AnsiString; virtual;
    ...
    function GetSchemaTerm: AnsiString; virtual;
    function GetProcedureTerm: AnsiString; virtual;
    function GetCatalogTerm: AnsiString; virtual;
    function IsCatalogAtStart: Boolean; virtual;
    function GetCatalogSeparator: AnsiString; virtual;
    ...
    procedure ClearCache(const Key: AnsiString);overload;virtual;

    // --> technobot 2008-06-14:  metadata cache key retrieval API:
    function GetTablesCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString; const Types: TStringDynArray): AnsiString;
    function GetSchemasCacheKey: AnsiString;
    function GetCatalogsCacheKey: AnsiString;
    function GetTableTypesCacheKey: AnsiString;
    function GetColumnsCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString; const ColumnNamePattern: AnsiString): AnsiString;
    function GetColumnPrivilegesCacheKey(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString; const ColumnNamePattern: AnsiString): AnsiString;
    function GetTablePrivilegesCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TableNamePattern: AnsiString): AnsiString;
    function GetPrimaryKeysCacheKey(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): AnsiString;
    function GetImportedKeysCacheKey(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): AnsiString;
    function GetExportedKeysCacheKey(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): AnsiString;
    function GetCrossReferenceCacheKey(const PrimaryCatalog: AnsiString; const PrimarySchema: AnsiString;
      const PrimaryTable: AnsiString; const ForeignCatalog: AnsiString; const ForeignSchema: AnsiString;
      const ForeignTable: AnsiString): AnsiString;
    function GetIndexInfoCacheKey(const Catalog: AnsiString; const Schema: AnsiString; const Table: AnsiString;
      const Unique: Boolean; const Approximate: Boolean): AnsiString;
    function GetSequencesCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const SequenceNamePattern: AnsiString): AnsiString;
    function GetProceduresCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const ProcedureNamePattern: AnsiString): AnsiString;
    function GetProcedureColumnsCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const ProcedureNamePattern: AnsiString; const ColumnNamePattern: AnsiString): AnsiString;
    function GetBestRowIdentifierCacheKey(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString; const Scope: Integer; const Nullable: Boolean): AnsiString;
    function GetVersionColumnsCacheKey(const Catalog: AnsiString; const Schema: AnsiString;
      const Table: AnsiString): AnsiString;
    function GetTypeInfoCacheKey: AnsiString;
    function GetUDTsCacheKey(const Catalog: AnsiString; const SchemaPattern: AnsiString;
      const TypeNamePattern: AnsiString; const Types: TIntegerDynArray): AnsiString;
  ...
  protected
    ...
    function IsLowerCase(const Value: AnsiString): Boolean;
    function IsUpperCase(const Value: AnsiString): Boolean;
    function IsSpecialCase(const Value: AnsiString): Boolean;
  public
    constructor Create(Metadata: IZDatabaseMetadata);

    function IsCaseSensitive(const Value: AnsiString): Boolean;
    function IsQuoted(const Value: AnsiString): Boolean;
    function Quote(const Value: AnsiString): AnsiString;
    function ExtractQuote(const Value: AnsiString): AnsiString;
  end;

  function GetTablesMetaDataCacheKey(Const Catalog:AnsiString;
      Const SchemaPattern:AnsiString;	Const TableNamePattern:AnsiString;const Types: TStringDynArray):AnsiString;
...
{**
  ...
  @param Url a database connection url AnsiString.
  @param Info an extra connection properties.
}
constructor TZAbstractDatabaseMetadata.Create(
  ParentConnection: IZConnection; const Url: AnsiString; Info: TStrings);
begin
...
procedure TZAbstractDatabaseMetadata.ClearCache(const Key: AnsiString);
var
  TempKey: IZAnyValue;
begin
...
procedure TZAbstractDatabaseMetadata.AddResultSetToCache(const Key: AnsiString;
...
function TZAbstractDatabaseMetadata.GetResultSetFromCache(
  const Key: AnsiString): IZResultSet;
var
  TempKey: IZAnyValue;
begin
  TempKey := TZAnyValue.CreateWithString(Key);
...
function TZAbstractDatabaseMetadata.GetURL: AnsiString;
begin
  Result := FUrl;
end;
...
function TZAbstractDatabaseMetadata.GetUserName: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetDatabaseProductName: AnsiString;
begin
  Result := '';
end;
...
function TZAbstractDatabaseMetadata.GetDatabaseProductVersion: AnsiString;
begin
  Result := '';
end;
...
function TZAbstractDatabaseMetadata.GetDriverName: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetDriverVersion: AnsiString;
begin
...
{**
  What's the AnsiString used to quote SQL identifiers?
  This returns a space " " if identifier quoting isn't supported.
  A JDBC Compliant<sup><font size=-2>TM</font></sup>
  driver always uses a double quote character.
  @return the quoting AnsiString
}
function TZAbstractDatabaseMetadata.GetIdentifierQuoteString: AnsiString;
begin
  Result := '"';
end;
...
function TZAbstractDatabaseMetadata.GetSQLKeywords: AnsiString;
begin
  Result := '';
end;
...
function TZAbstractDatabaseMetadata.GetNumericFunctions: AnsiString;
begin
  Result := '';
end;

{**
  Gets a comma-separated list of AnsiString functions.  These are the
  X/Open CLI AnsiString function names used in the JDBC function escape
  clause.
  @return the list
}
function TZAbstractDatabaseMetadata.GetStringFunctions: AnsiString;
begin
  Result := '';
end;
...
function TZAbstractDatabaseMetadata.GetSystemFunctions: AnsiString;
begin
  Result := '';
end;
...
function TZAbstractDatabaseMetadata.GetTimeDateFunctions: AnsiString;
begin
  Result := '';
end;

{**
  Gets the AnsiString that can be used to escape wildcard characters.
  This is the AnsiString that can be used to escape '_' or '%' in
  the AnsiString pattern style catalog search parameters.

  <P>The '_' character represents any single character.
  <P>The '%' character represents any sequence of zero or
  more characters.

  @return the AnsiString used to escape wildcard characters
}
function TZAbstractDatabaseMetadata.GetSearchStringEscape: AnsiString;
begin
  Result := '%';
end;
...
{**
  ...
  @return the AnsiString containing the extra characters
}
function TZAbstractDatabaseMetadata.GetExtraNameCharacters: AnsiString;
begin
  Result := '';
end;
...
function TZAbstractDatabaseMetadata.GetSchemaTerm: AnsiString;
begin
  Result := 'Schema';
end;
...
function TZAbstractDatabaseMetadata.GetProcedureTerm: AnsiString;
begin
  Result := 'Procedure';
end;
...
function TZAbstractDatabaseMetadata.GetCatalogTerm: AnsiString;
begin
  Result := 'Catalog';
end;
...
{**
  ...
  @return the separator AnsiString
}
function TZAbstractDatabaseMetadata.GetCatalogSeparator: AnsiString;
begin
  Result := '.';
end;
...
{**
  ...
  <P>Each procedure description has the the following columns:
   <OL>
 	<LI><B>PROCEDURE_CAT</B> AnsiString => procedure catalog (may be null)
 	<LI><B>PROCEDURE_SCHEM</B> AnsiString => procedure schema (may be null)
 	<LI><B>PROCEDURE_NAME</B> AnsiString => procedure name
   <LI> reserved for future use
   <LI> reserved for future use
   <LI> reserved for future use
 	<LI><B>REMARKS</B> AnsiString => explanatory comment on the procedure
...
function TZAbstractDatabaseMetadata.GetProcedures(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetProcedures(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString): IZResultSet;
begin
...
{**
  ...
  column description with the following fields:
   <OL>
 	...
 	<LI><B>PROCEDURE_SCHEM</B> AnsiString => procedure schema (may be null)
 	<LI><B>PROCEDURE_NAME</B> AnsiString => procedure name
 	<LI><B>COLUMN_NAME</B> AnsiString => column/parameter name
   ...
   <LI><B>DATA_TYPE</B> short => SQL type from java.sql.Types
 	<LI><B>TYPE_NAME</B> AnsiString => SQL type name, for a UDT type the
   type name is fully qualified
 	...
 	<LI><B>REMARKS</B> AnsiString => comment describing parameter/column
   </OL>
...
function TZAbstractDatabaseMetadata.GetProcedureColumns(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetProcedureColumns(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): IZResultSet;
begin
...
{**
  ...
  <P>Each table description has the following columns:
   <OL>
 	<LI><B>TABLE_CAT</B> AnsiString => table catalog (may be null)
 	<LI><B>TABLE_SCHEM</B> AnsiString => table schema (may be null)
 	<LI><B>TABLE_NAME</B> AnsiString => table name
 	<LI><B>TABLE_TYPE</B> AnsiString => table type.  Typical types are "TABLE",
 			"VIEW",	"SYSTEM TABLE", "GLOBAL TEMPORARY",
 			"LOCAL TEMPORARY", "ALIAS", "SYNONYM".
 	<LI><B>REMARKS</B> AnsiString => explanatory comment on the table
   </OL>
...
function TZAbstractDatabaseMetadata.GetTables(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
...
function TZAbstractDatabaseMetadata.UncachedGetTables(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const Types: TStringDynArray): IZResultSet;
begin
...
{**
  ...
  <P>The schema column is:
   <OL>
 	<LI><B>TABLE_SCHEM</B> AnsiString => schema name
   </OL>

  @return <code>ResultSet</code> - each row has a single AnsiString column that is a
  schema name
}
...
{**
  ...
  <P>The catalog column is:
   <OL>
 	<LI><B>TABLE_CAT</B> AnsiString => catalog name
   </OL>
...
{**
  ...
  <P>Each column description has the following columns:
   <OL>
 	...
 	<LI><B>TABLE_SCHEM</B> AnsiString => table schema (may be null)
 	<LI><B>TABLE_NAME</B> AnsiString => table name
 	<LI><B>COLUMN_NAME</B> AnsiString => column name
 	<LI><B>DATA_TYPE</B> short => SQL type from java.sql.Types
 	<LI><B>TYPE_NAME</B> AnsiString => Data source dependent type name,
   for a UDT the type name is fully qualified
 	...
 	<LI><B>REMARKS</B> AnsiString => comment describing column (may be null)
  	<LI><B>COLUMN_DEF</B> AnsiString => default value (may be null)
 	...
 	<LI><B>ORDINAL_POSITION</B> int	=> index of column in table
       (starting at 1)
 	<LI><B>IS_NULLABLE</B> AnsiString => "NO" means column definitely
       does not allow NULL values; "YES" means the column might
       allow NULL values.  An empty AnsiString means nobody knows.
   </OL>
...
function TZAbstractDatabaseMetadata.GetColumns(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): IZResultSet;
var
  Key: AnsiString;
...
function TZAbstractDatabaseMetadata.UncachedGetColumns(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): IZResultSet;
begin
...
{**
  ...
  <P>Each privilige description has the following columns:
   <OL>
 	...
 	<LI><B>GRANTEE</B> AnsiString => grantee of access
 	<LI><B>PRIVILEGE</B> AnsiString => name of access (SELECT,
       INSERT, UPDATE, REFRENCES, ...)
 	<LI><B>IS_GRANTABLE</B> AnsiString => "YES" if grantee is permitted
...
function TZAbstractDatabaseMetadata.GetColumnPrivileges(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetColumnPrivileges(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; const ColumnNamePattern: AnsiString): IZResultSet;
begin
...
function TZAbstractDatabaseMetadata.GetTablePrivileges(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetTablePrivileges(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString): IZResultSet;
begin
...
function TZAbstractDatabaseMetadata.GetBestRowIdentifier(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; Scope: Integer; Nullable: Boolean): IZResultSet;
var
  Key: AnsiString;
...
function TZAbstractDatabaseMetadata.UncachedGetBestRowIdentifier(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; Scope: Integer; Nullable: Boolean): IZResultSet;
var
  IndexName: AnsiString;
  ColumnNames: TStrings;
...
function TZAbstractDatabaseMetadata.GetVersionColumns(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetVersionColumns(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
begin
...
{**
  ...
  <P>Each primary key column description has the following columns:
   <OL>
 	...
 	<LI><B>PK_NAME</B> AnsiString => primary key name (may be null)
   </OL>
...
function TZAbstractDatabaseMetadata.GetPrimaryKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetPrimaryKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
begin
...
{**
  ...
  <P>Each primary key column description has the following columns:
   <OL>
 	<LI><B>PKTABLE_CAT</B> AnsiString => primary key table catalog
       being imported (may be null)
 	<LI><B>PKTABLE_SCHEM</B> AnsiString => primary key table schema
       being imported (may be null)
 	<LI><B>PKTABLE_NAME</B> AnsiString => primary key table name
       being imported
 	<LI><B>PKCOLUMN_NAME</B> AnsiString => primary key column name
       being imported
 	<LI><B>FKTABLE_CAT</B> AnsiString => foreign key table catalog (may be null)
 	<LI><B>FKTABLE_SCHEM</B> AnsiString => foreign key table schema (may be null)
 	<LI><B>FKTABLE_NAME</B> AnsiString => foreign key table name
 	<LI><B>FKCOLUMN_NAME</B> AnsiString => foreign key column name
 	...
 	<LI><B>FK_NAME</B> AnsiString => foreign key name (may be null)
 	<LI><B>PK_NAME</B> AnsiString => primary key name (may be null)
...
function TZAbstractDatabaseMetadata.GetImportedKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetImportedKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
begin
...
{**
  ...
  <P>Each foreign key column description has the following columns:
   <OL>
 	<LI><B>PKTABLE_CAT</B> AnsiString => primary key table catalog (may be null)
 	<LI><B>PKTABLE_SCHEM</B> AnsiString => primary key table schema (may be null)
 	<LI><B>PKTABLE_NAME</B> AnsiString => primary key table name
 	<LI><B>PKCOLUMN_NAME</B> AnsiString => primary key column name
 	<LI><B>FKTABLE_CAT</B> AnsiString => foreign key table catalog (may be null)
...
function TZAbstractDatabaseMetadata.GetExportedKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetExportedKeys(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): IZResultSet;
begin
...
function TZAbstractDatabaseMetadata.GetCrossReference(const PrimaryCatalog: AnsiString;
  const PrimarySchema: AnsiString; const PrimaryTable: AnsiString; const ForeignCatalog: AnsiString;
  const ForeignSchema: AnsiString; const ForeignTable: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.UncachedGetCrossReference(const PrimaryCatalog: AnsiString;
  const PrimarySchema: AnsiString; const PrimaryTable: AnsiString; const ForeignCatalog: AnsiString;
  const ForeignSchema: AnsiString; const ForeignTable: AnsiString): IZResultSet;
var
  Key: AnsiString;
...
{**
  ...
  <P>Each type description has the following columns:
   <OL>
 	<LI><B>TYPE_NAME</B> AnsiString => Type name
 	<LI><B>DATA_TYPE</B> short => SQL data type from java.sql.Types
 	<LI><B>PRECISION</B> int => maximum precision
 	<LI><B>LITERAL_PREFIX</B> AnsiString => prefix used to quote a literal
       (may be null)
 	<LI><B>LITERAL_SUFFIX</B> AnsiString => suffix used to quote a literal
        (may be null)
 	<LI><B>CREATE_PARAMS</B> AnsiString => parameters used in creating
 	...
 	<LI><B>LOCAL_TYPE_NAME</B> AnsiString => localized version of type name
       (may be null)
...
{**
  ...
  <P>Each index column description has the following columns:
   <OL>
 	...
 	<LI><B>INDEX_QUALIFIER</B> AnsiString => index catalog (may be null);
       null when TYPE is tableIndexStatistic
 	<LI><B>INDEX_NAME</B> AnsiString => index name; null when TYPE is
       tableIndexStatistic
 	...
 	<LI><B>COLUMN_NAME</B> AnsiString => column name; null when TYPE is
       tableIndexStatistic
 	<LI><B>ASC_OR_DESC</B> AnsiString => column sort sequence, "A" => ascending,
 	...
 	<LI><B>FILTER_CONDITION</B> AnsiString => Filter condition, if any.
       (may be null)
   </OL>
...
function TZAbstractDatabaseMetadata.GetIndexInfo(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; Unique: Boolean;
...
function TZAbstractDatabaseMetadata.UncachedGetIndexInfo(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; Unique: Boolean;
  Approximate: Boolean): IZResultSet;
begin
...
function TZAbstractDatabaseMetadata.GetSequences(const Catalog, SchemaPattern,
  SequenceNamePattern: AnsiString): IZResultSet;
var
  Key: AnsiString;
begin
...
{**
  ...
  <P>Each type description has the following columns:
   <OL>
 	<LI><B>TYPE_CAT</B> AnsiString => the type's catalog (may be null)
 	<LI><B>TYPE_SCHEM</B> AnsiString => type's schema (may be null)
 	<LI><B>TYPE_NAME</B> AnsiString => type name
   <LI><B>CLASS_NAME</B> AnsiString => Java class name
 	<LI><B>DATA_TYPE</B> AnsiString => type value defined in java.sql.Types.
   One of JAVA_OBJECT, STRUCT, or DISTINCT
 	<LI><B>REMARKS</B> AnsiString => explanatory comment on the type
   </OL>
...
function TZAbstractDatabaseMetadata.GetUDTs(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TypeNamePattern: AnsiString;
...
function TZAbstractDatabaseMetadata.UnCachedGetUDTs(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TypeNamePattern: AnsiString;
  const Types: TIntegerDynArray): IZResultSet;
begin
...
function TZAbstractDatabaseMetadata.AddEscapeCharToWildcards(
  const Pattern: AnsiString): AnsiString;
var i:Integer;
    EscapeChar : AnsiString;
begin
...
{**
  ...
  @param ProcedureNamePattern a procedure name pattern
  @return the cache key AnsiString
}
function TZAbstractDatabaseMetadata.GetProceduresCacheKey(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetProcedureColumnsCacheKey(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const ProcedureNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetTablesCacheKey(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const Types: TStringDynArray): AnsiString;
var
  I: Integer;
  Key: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetSchemasCacheKey: AnsiString;
begin
  Result := 'get-schemas';
end;
...
function TZAbstractDatabaseMetadata.GetCatalogsCacheKey: AnsiString;
begin
  Result := 'get-catalogs';
end;
...
function TZAbstractDatabaseMetadata.GetTableTypesCacheKey: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetColumnsCacheKey(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TableNamePattern: AnsiString;
  const ColumnNamePattern: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetColumnPrivilegesCacheKey(
  const Catalog: AnsiString; const Schema: AnsiString; const Table: AnsiString;
  const ColumnNamePattern: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetTablePrivilegesCacheKey(
  const Catalog: AnsiString; const SchemaPattern: AnsiString;
  const TableNamePattern: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetBestRowIdentifierCacheKey(
  const Catalog: AnsiString; const Schema: AnsiString; const Table: AnsiString;
  const Scope: Integer; const Nullable: Boolean): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetVersionColumnsCacheKey(
  const Catalog: AnsiString; const Schema: AnsiString; const Table: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetPrimaryKeysCacheKey(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetImportedKeysCacheKey(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetExportedKeysCacheKey(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetCrossReferenceCacheKey(
  const PrimaryCatalog: AnsiString; const PrimarySchema: AnsiString;
  const PrimaryTable: AnsiString; const ForeignCatalog: AnsiString;
  const ForeignSchema: AnsiString; const ForeignTable: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetTypeInfoCacheKey: AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetIndexInfoCacheKey(const Catalog: AnsiString;
  const Schema: AnsiString; const Table: AnsiString; const Unique: Boolean;
  const Approximate: Boolean): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetSequencesCacheKey(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const SequenceNamePattern: AnsiString): AnsiString;
begin
...
function TZAbstractDatabaseMetadata.GetUDTsCacheKey(const Catalog: AnsiString;
  const SchemaPattern: AnsiString; const TypeNamePattern: AnsiString;
  const Types: TIntegerDynArray): AnsiString;
var
  I: Integer;
begin
  Result := '';
...
{**
  fills AnsiString list with the keys for the currently cached metadata entries
  @param List a AnsiString list to fill out
}
...
{**
  ...
  @param SQL an SQL query AnsiString.
}
constructor TZVirtualResultSet.CreateWithStatement(const SQL: AnsiString;
...
{**
  Checks is the specified AnsiString in lower case.
  @param an identifier AnsiString.
  @return <code>True</code> is the identifier AnsiString in lower case.
}
function TZDefaultIdentifierConvertor.IsLowerCase(const Value: AnsiString): Boolean;
var
  I: Integer;
begin
  Result := True;
...
{**
  Checks is the specified AnsiString in upper case.
  @param an identifier AnsiString.
  @return <code>True</code> is the identifier AnsiString in upper case.
}
function TZDefaultIdentifierConvertor.IsUpperCase(const Value: AnsiString): Boolean;
var
  I: Integer;
begin
  Result := True;
...
{**
  Checks is the specified AnsiString in special case.
  @param an identifier AnsiString.
  @return <code>True</code> is the identifier AnsiString in mixed case.
}
function TZDefaultIdentifierConvertor.IsSpecialCase(const Value: AnsiString): Boolean;
var
  I: Integer;
begin
  Result := False;
...
{**
  Checks is the AnsiString case sensitive.
  @return <code>True</code> if the AnsiString case sensitive.
}
function TZDefaultIdentifierConvertor.IsCaseSensitive(const Value: AnsiString): Boolean;
const
...
{**
  Checks is the AnsiString quoted.
  @return <code>True</code> is the AnsiString quoted.
}
function TZDefaultIdentifierConvertor.IsQuoted(const Value: AnsiString): Boolean;
var
  QuoteDelim: AnsiString;
begin
...
{**
  Extracts the quote from the idenfitier AnsiString.
  @param an identifier AnsiString.
  @return a extracted and processed AnsiString.
}
function TZDefaultIdentifierConvertor.ExtractQuote(const Value: AnsiString): AnsiString;
begin
...
{**
  Quotes the identifier AnsiString.
  @param an identifier AnsiString.
  @return a quoted AnsiString.
}
function TZDefaultIdentifierConvertor.Quote(const Value: AnsiString): AnsiString;
var
  QuoteDelim: AnsiString;
begin
  Result := Value;

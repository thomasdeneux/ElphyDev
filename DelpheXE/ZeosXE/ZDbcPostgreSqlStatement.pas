...
type
  ...
  private
    ...
    FOidAsBlob: Boolean;
  protected
    function CreateResultSet(const SQL: AnsiString;
  ...
  protected
    ...
    function PrepareSQLParam(ParamIndex: Integer): AnsiString; override;
  public
    constructor Create(PlainDriver: IZPostgreSQLPlainDriver;
      Connection: IZConnection; const SQL: AnsiString; Info: TStrings;
...
function TZPostgreSQLStatement.CreateResultSet(const SQL: AnsiString;
  QueryHandle: PZPostgreSQLResult): IZResultSet;
var
...
function TZPostgreSQLStatement.ExecuteQuery(const SQL: AnsiString): IZResultSet;
var
...
function TZPostgreSQLStatement.ExecuteUpdate(const SQL: AnsiString): Integer;
var
  QueryHandle: PZPostgreSQLResult;
begin
  Result := -1;
...
function TZPostgreSQLStatement.Execute(const SQL: AnsiString): Boolean;
var
  QueryHandle: PZPostgreSQLResult;
...
constructor TZPostgreSQLPreparedStatement.Create(
  ...
  const SQL: AnsiString; Info: TStrings; Handle: PZPostgreSQLConnect);
begin
...
{**
  ...
  @return a AnsiString representation of the parameter.
}
function TZPostgreSQLPreparedStatement.PrepareSQLParam(
  ParamIndex: Integer): AnsiString;
var
  Value: TZVariant;

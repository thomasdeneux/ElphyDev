...
{$IFDEF FPC} {$mode delphi} {$DEFINE AcqElphy2} {$A1} {$Z1} {$ENDIF}
    ...
    type
        ...
        private
            _table,_application,_application_table:AnsiString;
        ...
        public
            ...
            constructor Create(table:AnsiString;application:AnsiString='';view_on:AnsiString='');overload;
            destructor Destroy;override;
            procedure initModel(table:AnsiString;application:AnsiString='';view_on:AnsiString='');
            function has_key(key:AnsiString):Boolean;
            function is_pkey(key:AnsiString):Boolean;
            function is_fkey(key:AnsiString):Boolean;
            function getPk:AnsiString;
            function getFk:AnsiString;
            ...
            property table:AnsiString read _table;
            property application:AnsiString read _application;
            property application_table:AnsiString read _application_table;
...
procedure proTDBModel_Create(table:AnsiString;var pu:typeUO);pascal;
function fonctionTDBModel_hasKey(key:AnsiString;var pu:typeUO):Boolean;pascal;
function fonctionTDBModel_isPKey(key:AnsiString;var pu:typeUO):Boolean;pascal;
function fonctionTDBModel_isFKey(key:AnsiString;var pu:typeUO):Boolean;pascal;
...
function fonctionTDBModel_getTable(var pu:typeUO):AnsiString;pascal;
function fonctionTDBModel_getConstraint(key:AnsiString;var pu:typeUO):AnsiString;pascal;
function fonctionTDBModel_getType(key:AnsiString;var pu:typeUO):AnsiString;pascal;
...
procedure proTDBModel_getLookup(key:AnsiString;var memo:TstmMemo;var pu:typeUO);pascal;
...
implementation
    ...
    constructor TDBModel.Create(table:AnsiString;application:AnsiString='';view_on:AnsiString='');
        begin
            notPublished := True;
            inherited Create;
    ...
    procedure TDBModel.initModel(table:AnsiString;application:AnsiString='';view_on:AnsiString='');
        var
            ...
            default,query,constraint,constraint_type,foreign_constraint,foreign_table,foreign_field,fd,tp:AnsiString;
    ...
    function TDBModel.has_key(key:AnsiString):Boolean;
        begin
            if _fields.IndexOf(key) > 0 then Result := True else Result := False;
        end;

    function TDBModel.is_pkey(key:AnsiString):Boolean;
        begin
            if has_key(key) then
    ...
    function TDBModel.is_fkey(key:AnsiString):Boolean;
        begin
            if has_key(key) then
    ...
    function TDBModel.getPk:AnsiString;
        var
            i:integer;
            st,separator:AnsiString;
    ...
    function TDBModel.getFk:AnsiString;
        var
            i:integer;
            st,separator,field:AnsiString;
    ...
    class function TDBModel.stmClassName:AnsiString;
        begin
            result:='DBModel';
        end;
    ...
    procedure proTDBModel_getFields(var memo:TstmMemo;var pu:typeUO);pascal;
        ...
        begin
            ...
            memo.stList.Clear;
            for i:=1 to model.fields.Count do memo.stList.add(model.fields[i-1]);
        end;
    ...
    procedure proTDBModel_getPKeys(var memo:TstmMemo;var pu:typeUO);pascal;
        ...
        begin
            ...
            verifierObjet(typeUO(memo));
            memo.stList.Clear;
            for i:=1 to model.pkeys.Count do memo.stList.add(model.pkeys[i-1]);
        end;
    ...
    procedure proTDBModel_getFKeys(var memo:TstmMemo;var pu:typeUO);pascal;
        ...
        begin
            ...
            verifierObjet(typeUO(memo));
            memo.stList.Clear;
            for i:=1 to model.fkeys.Count do memo.stList.add(model.fkeys[i-1]);
        end;
    ...
    procedure proTDBModel_getLookup(key:AnsiString;var memo:TstmMemo;var pu:typeUO);pascal;
        ...
        begin
            ...
            verifierObjet(typeUO(memo));
            memo.stList.Clear;
            if model.is_fkey(key) then memo.stList.Add(model.lookups.Values[key] + '.' + model.references.Values[key]);
        end;

Initialization
AffDebug('Initialization DBModels',0);

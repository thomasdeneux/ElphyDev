...
type
  ...
  {----------------------------------}
  TALWinInetInternetOpenAccessType = (
  ...
  private
    FAccessType: TALWinInetInternetOpenAccessType;
    ...
    procedure SetAccessType(const Value: TALWinInetInternetOpenAccessType);
  ...
  published
    property  AccessType: TALWinInetInternetOpenAccessType read FAccessType write SetAccessType default wHttpAt_Preconfig;
...
const AccessTypeArr: Array[TALWinInetInternetOpenAccessType] of DWord = (
...
{******************************************************************************************}
procedure TALWinInetHTTPClient.SetAccessType(const Value: TALWinInetInternetOpenAccessType);
begin

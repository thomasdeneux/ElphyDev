...
Description:  Function to work on Html Tag (extract Text, HTML encode,
...
{Html Tag function}
procedure ALANSIExtractHTMLText(HtmlContent: String; Var LstExtractedResourceText : Tstrings; Const DecodeHTMLText: Boolean = True);
procedure ALUTF8ExtractHTMLText(HtmlContent: UTF8String; Var LstExtractedResourceText : Tstrings; Const DecodeHTMLText: Boolean = True);
...
begin
  ...
  L := Length(src);
  if L = 0 then exit;
  GetMem(Buf, L * 12); // to be on the *very* safe side
  try
    P := Buf;

...
product:      TALHttpClient base class
Version:      3.06

Description:  TALHttpClient is a ancestor or class like
...
type
  ...
  public
    ...
    Procedure PostMultipartFormData(aUrl:String; aPostDataStrings: TStrings; aPostDataFiles: TALMultiPartFormDataFiles; aResponseContentStream: TStream; aResponseContentHeader: TALHTTPResponseHeader); overload;
    ...
    Function  PostMultiPartFormData(aUrl:String; aPostDataStrings: TStrings; aPostDataFiles: TALMultiPartFormDataFiles): String; overload;
  published
...
procedure TALHTTPClient.PostMultiPartFormData(aUrl: String;
                                              ...
                                              aPostDataFiles: TALMultiPartFormDataFiles;
                                              aResponseContentStream: TStream;
                                              aResponseContentHeader: TALHTTPResponseHeader);
...
begin
  ...
  try
    ...
    FrequestHeader.ContentType := TAlMultiPartFormDataStream(aMultipartFormDataEncoder.ContentStream).RequestContentType;
    post(
         aUrl,
         aMultipartFormDataEncoder.ContentStream,
         aResponseContentStream,
         aResponseContentHeader
        );
  finally
...
function TALHTTPClient.PostMultiPartFormData(aUrl: String;
                                             aPostDataStrings: TStrings;
                                             aPostDataFiles: TALMultiPartFormDataFiles): String;
Var aMultipartFormDataEncoder: TALMultipartFormDataEncoder;
    OldRequestContentType: String;
begin
  aMultipartFormDataEncoder := TALMultipartFormDataEncoder.create;

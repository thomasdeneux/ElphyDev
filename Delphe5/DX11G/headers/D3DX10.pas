...
type
    ...
    TD3DMATRIX = array [1 .. 4, 1 .. 4] of single;
    ...
    TD3DXMATRIX = object
        ...
        constructor Create(m1: TD3DMATRIX); overload;
        constructor CreateByFloat16(pf: PD3DXFLOAT16);
...
type
    ...
    TD3DX10_IMAGE_LOAD_INFO = object
        Width: UINT;
        Height: UINT;
        Depth: UINT;
        FirstMipLevel: UINT;
    ...
    TD3DX10_TEXTURE_LOAD_INFO = object
        pSrcBox: pD3D10_BOX;
        pDstBox: PD3D10_BOX;
        SrcFirstMip: UINT;
        DstFirstMip: UINT;
...
begin
    if pf = nil then  Exit;
    D3DXFloat16To32Array(@m, pf, 16);
end;



constructor TD3DXMATRIX.Create(m1: TD3DMATRIX);
begin
    Move(m1, m, SizeOf(TD3DXMATRIX));
end;
...
begin
    ...
    if (pM = nil) then
        Exit;
    with pm^ do
    Result := (m[1][1] = 1.0) and (m[1][2] = 0.0) and (m[1][3] = 0.0) and (m[1][4] = 0.0) and
              (m[2][1] = 0.0) and (m[2][2] = 1.0) and (m[2][3] = 0.0) and (m[2][4] = 0.0) and
              (m[3][1] = 0.0) and (m[3][2] = 0.0) and (m[3][3] = 1.0) and (m[3][4] = 0.0) and
              (m[4][1] = 0.0) and (m[4][2] = 0.0) and (m[4][3] = 0.0) and (m[4][4] = 1.0);
end;

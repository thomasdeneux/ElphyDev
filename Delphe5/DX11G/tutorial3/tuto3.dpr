...
Begin
  ...
  While true do Begin
    ...
    //Draw here
    ARenderer.Clear(D3DColor4f(0.0, 0.15, 0.5, 1));
    ARenderer.Render;
    ARenderer.Present;
  end;
End;
...
begin
  ...
  InitializeWindow;
  messageCentral('sz='+Istr(sizeof(TD3DXCOLOR)));

  //Create our renderer class, which will initialize Direct3D 11
  ARenderer := TDXRenderer.Create(app_hwnd, screen_width, screen_height);

...
{$IFDEF WIN64}
  ...
  GnativeUINT = UINT64;
{$ELSE}
  GnativeInt = integer;   // Bug dans Delphi7 sur nativeInt et NativeUINT
  GnativeUINT = longword;
{$ENDIF}
...
const
  ...
  H5_VERS_RELEASE = 17;  (* For tweaks, bug-fixes, or development *)
  H5_VERS_SUBRELEASE = '';  (* For pre-releases like snap0 *)
(* Empty string for real releases.           *)
  H5_VERS_INFO = 'HDF5 library version: 1.8.17';  (* Full version string *)
...
type
  ...
  public
    ...
    property H5T_NATIVE_INT
    : hid_t read FH5T_NATIVE_INT;
...
begin
  try
    hdf5:= Thdf5dll.Create(AppDir+'hdf5\hdf5.dll');
    result:=true;
  except
    result:=false;
  end;    

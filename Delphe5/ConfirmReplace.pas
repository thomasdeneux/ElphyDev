...
function ConfirmReplaceDialog: TConfirmReplaceDialog;
begin
  if not assigned(FConfirmReplaceDialog) then FConfirmReplaceDialog:= TConfirmReplaceDialog.create(nil);
...
procedure TConfirmReplaceDialog.PrepareShow(AEditorRect: TRect;
  X, Y1, Y2: integer; AReplaceText: AnsiString);
var
  nW, nH: integer;
begin
...
Initialization
AffDebug('Initialization ConfirmReplace',0);
{$IFDEF FPC}
{$I ConfirmReplace.lrs}
{$ENDIF}
end.

...
// Same as D3DX9.pas but with dynamic loading (see InitD3DX9lib )

{ Tous les packed record ont été remplacés par record pour un fonctionnement correct en 64 bits
...
var
D3DXFloat32To16Array: function (pOut: PD3DXFloat16; pIn: PSingle; n: LongWord): PD3DXFloat16; stdcall;
{$EXTERNALSYM D3DXFloat32To16Array}

// Converts an array 16-bit floats to 32-bit floats
D3DXFloat16To32Array: function (pOut: PSingle; pIn: PD3DXFloat16; n: LongWord): PSingle; stdcall;
...
D3DXVec2TransformArray: function (pOut: PD3DXVector4; OutStride: LongWord;
  pV: PD3DXVector2; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector4; stdcall;
{$EXTERNALSYM D3DXVec2TransformArray}

// Transform Array (x, y, 0, 1) by matrix, project result back into w=1.
D3DXVec2TransformCoordArray: function (pOut: PD3DXVector2; OutStride: LongWord;
  pV: PD3DXVector2; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector2; stdcall;
{$EXTERNALSYM D3DXVec2TransformCoordArray}

// Transform Array (x, y, 0, 0) by matrix.
D3DXVec2TransformNormalArray: function (pOut: PD3DXVector2; OutStride: LongWord;
  pV: PD3DXVector2; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector2; stdcall;
...
D3DXVec3TransformArray: function (pOut: PD3DXVector4; OutStride: LongWord;
  pV: PD3DXVector3; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector4; stdcall;
{$EXTERNALSYM D3DXVec3TransformArray}

// Transform Array (x, y, z, 1) by matrix, project result back into w=1.
D3DXVec3TransformCoordArray: function (pOut: PD3DXVector3; OutStride: LongWord;
  pV: PD3DXVector3; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector3; stdcall;
{$EXTERNALSYM D3DXVec3TransformCoordArray}

// Transform (x, y, z, 0) by matrix.  If you transforming a normal by a
// non-affine matrix, the matrix you pass to this function should be the
// transpose of the inverse of the matrix you would use to transform a coord.
D3DXVec3TransformNormalArray: function (pOut: PD3DXVector3; OutStride: LongWord;
  pV: PD3DXVector3; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector3; stdcall;
...
D3DXVec3ProjectArray: function (pOut: PD3DXVector3; OutStride: LongWord;
  pV: PD3DXVector3; VStride: LongWord; const pViewport: TD3DViewport9;
  const pProjection, pView, pWorld: TD3DXMatrix; n: LongWord): PD3DXVector3; stdcall;
{$EXTERNALSYM D3DXVec3ProjectArray}

// Project vector Array from screen space into object space
D3DXVec3UnprojectArray: function (pOut: PD3DXVector3; OutStride: LongWord;
  pV: PD3DXVector3; VStride: LongWord; const pViewport: TD3DViewport9;
  const pProjection, pView, pWorld: TD3DXMatrix; n: LongWord): PD3DXVector3; stdcall;
...
D3DXVec4TransformArray: function (pOut: PD3DXVector4; OutStride: LongWord;
  pV: PD3DXVector4; VStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXVector4; stdcall;
...
var
D3DXMatrixDeterminant: function (const m: TD3DXMatrix): Single; stdcall;
{$EXTERNALSYM D3DXMatrixDeterminant}

D3DXMatrixDecompose: function (pOutScale: PD3DXVector3; pOutRotation: PD3DXQuaternion;
   pOutTranslation: PD3DXVector3; const M: TD3DXMatrix): HRESULT; stdcall;
...
// Mout = Msc-1 * Msr-1 * Ms * Msr * Msc * Mrc-1 * Mr * Mrc * Mt
D3DXMatrixTransformation2D: function (out pOut: TD3DXMatrix;
   pScalingCenter: PD3DXVector2;
   ScalingRotation: Single; pScaling: PD3DXVector2; pRotationCenter: PD3DXVector2;
   Rotation: Single; pTranslation: PD3DXVector2): PD3DXMatrix; stdcall;
...
// Mout = Ms * Mrc-1 * Mr * Mrc * Mt
D3DXMatrixAffineTransformation2D: function (out mOut: TD3DXMatrix;
...
D3DXPlaneIntersectLine: function (out pOut: TD3DXVector3;
...
// M should be the inverse transpose of the transformation desired.
D3DXPlaneTransformArray: function (pOut: PD3DXPlane; OutStride: LongWord;
  pP: PD3DXPlane; PStride: LongWord; const m: TD3DXMatrix; n: LongWord): PD3DXPlane; stdcall;
...
var
D3DXSHEvalDirection: function (pOut: PSingle; Order: LongWord;
    const pDir: TD3DXVector3): PSingle; stdcall;
...
D3DXSHRotate: function (pOut: PSingle; Order: LongWord;
    const pMatrix: TD3DXMatrix; pIn: PSingle): PSingle; stdcall;
...
D3DXSHRotateZ: function (pOut: PSingle; Order: LongWord;
    Angle: Single; pIn: PSingle): PSingle; stdcall;
...
D3DXSHAdd: function (pOut: PSingle; Order: LongWord;
    pA, pB: PSingle): PSingle; stdcall;
...
D3DXSHScale: function (pOut: PSingle; Order: LongWord;
    pIn: PSingle; Scale: Single): PSingle; stdcall;
...
D3DXSHDot: function (Order: LongWord; pA, pB: PSingle): Single; stdcall;
...
D3DXSHMultiply2: function (pOut: PSingle; const pF, pG: PSingle): PSingle; stdcall;
{$EXTERNALSYM D3DXSHMultiply2}
D3DXSHMultiply3: function (pOut: PSingle; const pF, pG: PSingle): PSingle; stdcall;
{$EXTERNALSYM D3DXSHMultiply3}
D3DXSHMultiply4: function (pOut: PSingle; const pF, pG: PSingle): PSingle; stdcall;
{$EXTERNALSYM D3DXSHMultiply4}
D3DXSHMultiply5: function (pOut: PSingle; const pF, pG: PSingle): PSingle; stdcall;
{$EXTERNALSYM D3DXSHMultiply5}
D3DXSHMultiply6: function (pOut: PSingle; const pF, pG: PSingle): PSingle; stdcall;
...
D3DXSHEvalDirectionalLight: function (Order: LongWord; const pDir: TD3DXVector3;
    RIntensity: Single; GIntensity: Single; BIntensity: Single;
    pROut, pGOut, pBOut: PSingle): HResult; stdcall;
...
D3DXSHEvalSphericalLight: function (Order: LongWord; const pPos: TD3DXVector3; Radius: Single;
    RIntensity: Single; GIntensity: Single; BIntensity: Single;
    pROut, pGOut, pBOut: PSingle): HResult; stdcall;
...
D3DXSHEvalConeLight: function (Order: LongWord; const pDir: TD3DXVector3; Radius: Single;
    RIntensity: Single; GIntensity: Single; BIntensity: Single;
    pROut, pGOut, pBOut: PSingle): HResult; stdcall;
...
D3DXSHEvalHemisphereLight: function (Order: LongWord; const pDir: TD3DXVector3;
...
D3DXSHProjectCubeMap: function (Order: LongWord; pCubeMap: IDirect3DCubeTexture9;
    pROut, pGOut, pBOut: PSingle): HResult; stdcall;
...
var
D3DXCheckVersion: function (D3DSdkVersion, D3DXSdkVersion: LongWord): BOOL; stdcall;
...
D3DXDebugMute: function (Mute: BOOL): BOOL; stdcall;
...
D3DXGetDriverLevel: function (pDevice: IDirect3DDevice9): LongWord; stdcall;
...
var
D3DXCreateSprite: function (pDevice: IDirect3DDevice9;
...
D3DXCreateFont: function (
  ...
  PitchAndFamily: DWORD;
  pFaceName: PChar;
  out ppFont: ID3DXFont): HResult; stdcall;{ name 'D3DXCreateFontA';}
{$EXTERNALSYM D3DXCreateFont}


D3DXCreateFontIndirectA: function (
  pDevice: IDirect3DDevice9;
  const pDesc: TD3DXFontDescA;
  out ppFont: ID3DXFont): HResult; stdcall;
{$EXTERNALSYM D3DXCreateFontIndirectA}

D3DXCreateFontIndirectW: function (
  pDevice: IDirect3DDevice9;
...
D3DXCreateFontIndirect: function (
  ...
  out ppFont: ID3DXFont): HResult; stdcall;{ name 'D3DXCreateFontIndirectA';}
...
var
D3DXCreateRenderToSurface: function (ppDevice: IDirect3DDevice9;
  Width: LongWord;
  Height: LongWord;
  Format: TD3DFormat;
  DepthStencil: BOOL;
...
var
D3DXCreateRenderToEnvMap: function (ppDevice: IDirect3DDevice9;
  Size: LongWord;
  MipLevels: LongWord;
  Format: TD3DFormat;
  DepthStencil: BOOL;
...
var
D3DXCreateLine: function (ppDevice: IDirect3DDevice9;
...
D3DXAssembleShaderFromFileA: function (
  ...
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall;
...
D3DXAssembleShaderFromFile: function (
  ...
  Flags: DWORD;
  ppShader: PID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall; {name 'D3DXAssembleShaderFromFileA';}
...
D3DXAssembleShaderFromResource: function (
  ...
  Flags: DWord;
  ppShader: PID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall; {name 'D3DXAssembleShaderFromResourceA';}
...
D3DXCompileShaderFromFileA: function (
  pSrcFile: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  ...
  ppConstantTable: PID3DXConstantTable): HResult; stdcall;
{$EXTERNALSYM D3DXCompileShaderFromFileA}

D3DXCompileShaderFromFileW: function (
  pSrcFile: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  pFunctionName: PAnsiChar;
...
D3DXCompileShaderFromFile: function (
  ...
  ppShader: PID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer;
  ppConstantTable: PID3DXConstantTable): HResult; stdcall; { name 'D3DXCompileShaderFromFileA';}
{$EXTERNALSYM D3DXCompileShaderFromFile}


D3DXCompileShaderFromResourceA: function (
  hSrcModule: HModule;
  pSrcResource: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXCompileShaderFromResourceW: function (
  hSrcModule: HModule;
  pSrcResource: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXCompileShaderFromResource: function (
  ...
  ppShader: PID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer;
  ppConstantTable: PID3DXConstantTable): HResult; stdcall; {name 'D3DXCompileShaderFromResourceA'; }
...
D3DXDisassembleShader: function (
  ...
  pComments: PAnsiChar;
  out ppDisassembly: ID3DXBuffer): HResult; stdcall;
...
D3DXGetPixelShaderProfile: function (pDevice: IDirect3DDevice9): PAnsiChar; stdcall;
{$EXTERNALSYM D3DXGetPixelShaderProfile}

D3DXGetVertexShaderProfile: function (pDevice: IDirect3DDevice9): PAnsiChar; stdcall;
...
D3DXFindShaderComment: function (
  ...
  FourCC: DWORD;
  ppData: PPointer;
  pSizeInBytes: PLongWord): HResult; stdcall;
...
D3DXGetShaderSize: function (const pFunction: PDWORD): LongWord; stdcall;
...
D3DXGetShaderVersion: function (pFunction: PDWORD): DWORD; stdcall;
...
D3DXGetShaderInputSemantics: function (
  ...
  pCount: PLongWord): HResult; stdcall;
...
D3DXGetShaderConstantTable: function (
  pFunction: PDWORD;
  out ppConstantTable: ID3DXConstantTable): HResult; stdcall;
...
D3DXCreateTextureShader: function (
  ...
  out ppTextureShader: ID3DXTextureShader): HResult; stdcall;
...
D3DXGatherFragmentsFromFileA: function (
  pSrcFile: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  Flags: DWORD;
...
D3DXGatherFragmentsFromFileW: function (
  pSrcFile: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  Flags: DWORD;
...
D3DXGatherFragmentsFromFile: function (
  pSrcFile: PChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  Flags: DWORD;
  out ppShader: ID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall;{ name 'D3DXGatherFragmentsFromFileA';}
{$EXTERNALSYM D3DXGatherFragmentsFromFile}


D3DXGatherFragmentsFromResourceA: function (
  hSrcModule: HModule;
  pSrcResource: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXGatherFragmentsFromResourceW: function (
  hSrcModule: HModule;
  pSrcResource: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXGatherFragmentsFromResource: function (
  hSrcModule: HModule;
  pSrcResource: PChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  Flags: DWord;
  out ppShader: ID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall; {name 'D3DXGatherFragmentsFromResourceA';}
...
D3DXCreateFragmentLinker: function (
  ...
  out ppFragmentLinker: ID3DXFragmentLinker): HResult; stdcall;
...
D3DXPreprocessShaderFromFileA: function (
  pSrcFile: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXPreprocessShaderFromFileW: function (
  pSrcFile: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  out ppShaderText: ID3DXBuffer;
...
D3DXPreprocessShaderFromFile: function (
  ...
  pInclude: ID3DXInclude;
  out ppShaderText: ID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall; {name 'D3DXPreprocessShaderFromFileA';}
{$EXTERNALSYM D3DXPreprocessShaderFromFile}


D3DXPreprocessShaderFromResourceA: function (
  hSrcModule: HModule;
  pSrcResource: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXPreprocessShaderFromResourceW: function (
  hSrcModule: HModule;
  pSrcResource: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXPreprocessShaderFromResource: function (
  ...
  pInclude: ID3DXInclude;
  out ppShaderText: ID3DXBuffer;
  ppErrorMsgs: PID3DXBuffer): HResult; stdcall; {name 'D3DXPreprocessShaderFromResourceA';}
...
D3DXCreateEffectPool: function (
  out ppPool: ID3DXEffectPool): HResult; stdcall;
...
D3DXCreateEffectFromFile: function (
  ...
  pPool: ID3DXEffectPool;
  out ppEffect: ID3DXEffect;
  ppCompilationErrors: PID3DXBuffer): HResult; stdcall; {name 'D3DXCreateEffectFromFileA';}
...
D3DXCreateEffectFromResource: function (
  ...
  pPool: ID3DXEffectPool;
  out ppEffect: ID3DXEffect;
  ppCompilationErrors: PID3DXBuffer): HResult; stdcall; {name 'D3DXCreateEffectFromResourceA';}
...
D3DXCreateEffectFromFileExA: function (
  pDevice: IDirect3DDevice9;
  pSrcFile: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXCreateEffectFromFileExW: function (
  pDevice: IDirect3DDevice9;
  pSrcFile: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXCreateEffectFromFileEx: function (
  ...
  pPool: ID3DXEffectPool;
  out ppEffect: ID3DXEffect;
  ppCompilationErrors: PID3DXBuffer): HResult; stdcall; {name 'D3DXCreateEffectFromFileExA';}
{$EXTERNALSYM D3DXCreateEffectFromFileEx}


D3DXCreateEffectFromResourceExA: function (
  pDevice: IDirect3DDevice9;
  hSrcModule: HModule;
  pSrcResource: PAnsiChar;
  pDefines: PD3DXMacro;
...
D3DXCreateEffectFromResourceExW: function (
  pDevice: IDirect3DDevice9;
  hSrcModule: HModule;
  pSrcResource: PWideChar;
  pDefines: PD3DXMacro;
...
D3DXCreateEffectFromResourceEx: function (
  ...
  pPool: ID3DXEffectPool;
  out ppEffect: ID3DXEffect;
  ppCompilationErrors: PID3DXBuffer): HResult; stdcall; {name 'D3DXCreateEffectFromResourceExA';}
...
D3DXCreateEffectCompilerFromFileA: function (
  pSrcFile: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  Flags: DWORD;
  out ppCompiler: ID3DXEffectCompiler;
  ppParseErrors: PID3DXBuffer): HResult; stdcall;
{$EXTERNALSYM D3DXCreateEffectCompilerFromFileA}

D3DXCreateEffectCompilerFromFileW: function (
  pSrcFile: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
  Flags: DWORD;
...
D3DXCreateEffectCompilerFromFile: function (
  ...
  Flags: DWORD;
  out ppCompiler: ID3DXEffectCompiler;
  ppParseErrors: PID3DXBuffer): HResult; stdcall; {name 'D3DXCreateEffectCompilerFromFileA';}
{$EXTERNALSYM D3DXCreateEffectCompilerFromFile}


D3DXCreateEffectCompilerFromResourceA: function (
  hSrcModule: HModule;
  pSrcResource: PAnsiChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXCreateEffectCompilerFromResourceW: function (
  hSrcModule: HModule;
  pSrcResource: PWideChar;
  pDefines: PD3DXMacro;
  pInclude: ID3DXInclude;
...
D3DXCreateEffectCompilerFromResource: function (
  ...
  Flags: DWORD;
  out ppCompiler: ID3DXEffectCompiler;
  ppParseErrors: PID3DXBuffer): HResult; stdcall; {name 'D3DXCreateEffectCompilerFromResourceA';}
...
var
D3DXFileCreate: function (out DirectXFile: ID3DXFile): HResult; stdcall;
...
D3DXCreateMesh: function (NumFaces, NumVertices: DWord; Options: DWord;
  ...
  pD3DDevice: IDirect3DDevice9; out ppMesh: ID3DXMesh): HResult; stdcall;
{$EXTERNALSYM D3DXCreateMesh}

D3DXCreateMeshFVF: function (NumFaces, NumVertices: DWord; Options: DWord;
  FVF: DWord; pD3DDevice: IDirect3DDevice9; out ppMesh: ID3DXMesh): HResult; stdcall;
...
D3DXCleanMesh: function (CleanType: TD3DXCleanType; pMeshIn: ID3DXMesh; pAdjacencyIn: PDWord;
...
D3DXGeneratePMesh: function (pMesh: ID3DXMesh; pAdjacency: PDWord;
  pVertexAttributeWeights: PD3DXAttributeWeights; pVertexWeights: PSingle;
  MinValue: DWord; Options: TD3DXMeshSimp; out ppPMesh: ID3DXPMesh): HResult; stdcall;
{$EXTERNALSYM D3DXGeneratePMesh}

D3DXSimplifyMesh: function (pMesh: ID3DXMesh; pAdjacency: PDWord;
  pVertexAttributeWeights: PD3DXAttributeWeights; pVertexWeights: PSingle;
  MinValue: DWord; Options: TD3DXMeshSimp; out ppMesh: ID3DXMesh): HResult; stdcall;
...
D3DXComputeBoundingSphere: function (
  ...
  out pRadius: Single): HResult; stdcall;
...
D3DXComputeBoundingBox: function (
  ...
  NumVertices: DWORD;
  dwStride: DWORD;                     // count in bytes to subsequent position vectors
  out pMin, pMax: TD3DXVector3): HResult; stdcall;
...
D3DXLoadMeshFromX: function (
  ...
  ppAdjacency, ppMaterials, ppEffectInstances: PID3DXBuffer;
  pNumMaterials: PDWORD;
  out ppMesh: ID3DXMesh): HResult; stdcall; {name 'D3DXLoadMeshFromXA'; }
...
D3DXSaveMeshToX: function (
  ...
  pEffectInstances: PD3DXEffectInstance;
  NumMaterials: DWORD;
  Format: DWORD): HResult; stdcall; {name 'D3DXSaveMeshToXA';}
{$EXTERNALSYM D3DXSaveMeshToX}


D3DXCreatePMeshFromStream: function (
  pStream: IStream;
  Options: DWORD;
  pD3DDevice: IDirect3DDevice9;
...
D3DXGenerateOutputDecl: function (
  ...
  pInput: PD3DVertexElement9): HResult; stdcall;
...
D3DXLoadPatchMeshFromXof: function (
  ...
  ppEffectInstances: PID3DXBuffer;
  pNumMaterials: PDWORD;
  out ppMesh: ID3DXPatchMesh): HResult; stdcall;
...
D3DXCreateNPatchMesh: function (
  ...
  out pPatchMesh: ID3DXPatchMesh): HResult; stdcall;
...
D3DXGetDeclVertexSize: function (pDecl: PD3DVertexElement9; Stream: DWORD): LongWord; stdcall;
{$EXTERNALSYM D3DXGetDeclVertexSize}

D3DXGetDeclLength: function (pDecl: PD3DVertexElement9): LongWord; stdcall;
...
D3DXFVFFromDeclarator: function (pDeclarator: PD3DVertexElement9; out pFVF: DWord): HResult; stdcall;
...
D3DXComputeTangentFrame: function (pMesh: ID3DXMesh; dwOptions: DWORD): HResult; stdcall;
{$EXTERNALSYM D3DXComputeTangentFrame}

D3DXComputeTangentFrameEx: function (pMesh: ID3DXMesh;
...
D3DXComputeTangent: function (
  ...
  BinormIndex: DWORD;
  Wrap: DWORD;
  Adjacency: PDWORD): HResult; stdcall;
...
D3DXUVAtlasCreate: function (
  ...
  puNumChartsOut: PLongWord): HResult; stdcall;
...
D3DXUVAtlasPack: function (
  ...
  pUserContext: Pointer;
  dwOptions: TD3DXUVAtlas;
  pFacePartitioning: ID3DXBuffer): HResult; stdcall;
...
D3DXComputeIMTFromPerVertexSignal: function (
  ...
  pStatusCallback: TD3DXUVAtlasCB;
  pUserContext: Pointer;
  out ppIMTData: ID3DXBuffer): HResult; stdcall;
...
D3DXConvertMeshSubsetToSingleStrip: function (
  ...
  pNumIndices: PDWord): HResult; stdcall;
...
D3DXConvertMeshSubsetToStrips: function (
  ...
  pNumStrips: PDWord): HResult; stdcall;
...
D3DXOptimizeFaces: function (
  ...
  cVertices: LongWord;
  b32BitIndices: BOOL;
  pFaceRemap: PDWORD): HResult; stdcall;
...
D3DXOptimizeVertices: function (
  ...
  cVertices: LongWord;
  b32BitIndices: BOOL;
  pVertexRemap: PDWORD): HResult; stdcall;
...
D3DXCreatePRTBuffer: function (
  ...
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall;
...
D3DXLoadPRTBufferFromFileA: function (
  pFilename: PAnsiChar;
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall;
{$EXTERNALSYM D3DXLoadPRTBufferFromFileA}

D3DXLoadPRTBufferFromFileW: function (
  pFilename: PWideChar;
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall;
...
D3DXLoadPRTBufferFromFile: function (
  pFilename: PChar;
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall; {name 'D3DXLoadPRTBufferFromFileA';}
...
D3DXSavePRTBufferToFileA: function (
  pFilename: PAnsiChar;
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall;
{$EXTERNALSYM D3DXSavePRTBufferToFileA}

D3DXSavePRTBufferToFileW: function (
  pFilename: PWideChar;
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall;
...
D3DXSavePRTBufferToFile: function (
  pFilename: PChar;
  ppBuffer: ID3DXPRTBuffer): HResult; stdcall; {name 'D3DXSavePRTBufferToFileA';}
...
D3DXLoadPRTCompBufferFromFileA: function (
  pFilename: PAnsiChar;
  ppBuffer: ID3DXPRTCompBuffer): HResult; stdcall;
{$EXTERNALSYM D3DXLoadPRTCompBufferFromFileA}

D3DXLoadPRTCompBufferFromFileW: function (
  pFilename: PWideChar;
  ppBuffer: ID3DXPRTCompBuffer): HResult; stdcall;
...
D3DXLoadPRTCompBufferFromFile: function (
  pFilename: PChar;
  ppBuffer: ID3DXPRTCompBuffer): HResult; stdcall; {name 'D3DXLoadPRTCompBufferFromFileA';}
...
D3DXSavePRTCompBufferToFileA: function (
  pFilename: PAnsiChar;
  ppBuffer: ID3DXPRTCompBuffer): HResult; stdcall;
{$EXTERNALSYM D3DXSavePRTCompBufferToFileA}

D3DXSavePRTCompBufferToFileW: function (
  pFilename: PWideChar;
  ppBuffer: ID3DXPRTCompBuffer): HResult; stdcall;
...
D3DXSavePRTCompBufferToFile: function (
  pFilename: PChar;
  ppBuffer: ID3DXPRTCompBuffer): HResult; stdcall; {name 'D3DXSavePRTCompBufferToFileA';}
...
D3DXCreatePRTCompBuffer: function (
  ...
  out ppBufferOut: ID3DXPRTCompBuffer): HResult; stdcall;
...
D3DXCreateTextureGutterHelper: function (
  ...
  pMesh: ID3DXMesh;
  GutterSize: Single;
  out ppBuffer: ID3DXTextureGutterHelper): HResult; stdcall;
...
D3DXCreatePRTEngine: function (
  ...
  out ppEngine: ID3DXPRTEngine): HResult; stdcall;
...
D3DXSHPRTCompSuperCluster: function (
  ...
  out pNumSuperClusters: LongWord): HResult; stdcall;
...
D3DXSHPRTCompSplitMeshSC: function (
  ...
  pSCData: PD3DXSHPRTSplitMeshClusterData): HResult; stdcall;
...
//-------------------------------------------------------------------------
var
D3DXCreatePolygon: function (ppDevice: IDirect3DDevice9;
  Length: Single;
  Sides: LongWord;
...
//  ppAdjacency Returns a buffer containing adjacency info.  Can be NULL.
//-------------------------------------------------------------------------
D3DXCreateBox: function (ppDevice: IDirect3DDevice9;
  Width,
  Height,
  Depth: Single;
  out ppMesh: ID3DXMesh;
...
//  ppAdjacency Returns a buffer containing adjacency info.  Can be NULL.
//-------------------------------------------------------------------------
D3DXCreateCylinder: function (ppDevice: IDirect3DDevice9;
  Radius1,
  Radius2,
  Length: Single;
  Slices,
...
//  ppAdjacency Returns a buffer containing adjacency info.  Can be NULL.
//-------------------------------------------------------------------------
D3DXCreateSphere: function (ppDevice: IDirect3DDevice9;
  Radius: Single;
  Slices,
  Stacks: LongWord;
  out ppMesh: ID3DXMesh;
...
//  ppAdjacency Returns a buffer containing adjacency info.  Can be NULL.
//-------------------------------------------------------------------------
D3DXCreateTorus: function (ppDevice: IDirect3DDevice9;
  InnerRadius,
  OuterRadius: Single;
  Sides,
  Rings: LongWord;
...
//  ppAdjacency Returns a buffer containing adjacency info.  Can be NULL.
//-------------------------------------------------------------------------
D3DXCreateTeapot: function (ppDevice: IDirect3DDevice9;
  out ppMesh: ID3DXMesh;
  ppAdjacency: PID3DXBuffer): HResult; stdcall;
...
D3DXCreateTextA: function (ppDevice: IDirect3DDevice9;
  hDC: HDC;
  pText: PAnsiChar;
  Deviation: Single;
  Extrusion: Single;
...
D3DXCreateTextW: function (ppDevice: IDirect3DDevice9;
  hDC: HDC;
  pText: PWideChar;
  Deviation: Single;
  Extrusion: Single;
...
D3DXCreateText: function (ppDevice: IDirect3DDevice9;
  hDC: HDC;
  pText: PChar;
  Deviation: Single;
  Extrusion: Single;
  out ppMesh: ID3DXMesh;
  ppAdjacency: PID3DXBuffer;
  pGlyphMetrics: PGlyphMetricsFloat): HResult; stdcall; {name 'D3DXCreateTextA';}
...
D3DXGetImageInfoFromFile: function (
  pSrcFile: PChar;
  out pSrcInfo: TD3DXImageInfo): HResult; stdcall; {name 'D3DXGetImageInfoFromFileA';}
...
D3DXGetImageInfoFromResource: function (
  hSrcModule: HModule;
  pSrcResource: PChar;
  out pSrcInfo: TD3DXImageInfo): HResult; stdcall; {name 'D3DXGetImageInfoFromResourceA';}
...
D3DXLoadSurfaceFromFile: function (
  ...
  Filter: DWord;
  ColorKey: TD3DColor;
  pSrcInfo: PD3DXImageInfo): HResult; stdcall; {name 'D3DXLoadSurfaceFromFileA';}
...
D3DXLoadSurfaceFromResource: function (
  ...
  Filter: DWord;
  ColorKey: TD3DColor;
  pSrcInfo: PD3DXImageInfo): HResult; stdcall; {name 'D3DXLoadSurfaceFromResourceA';}
...
D3DXSaveSurfaceToFile: function (
  ...
  pSrcSurface: IDirect3DSurface9;
  pSrcPalette: PPaletteEntry;
  pSrcRect: PRect): HResult; stdcall; {name 'D3DXSaveSurfaceToFileA';}
...
D3DXLoadVolumeFromFile: function (
  ...
  Filter: DWord;
  ColorKey: TD3DColor;
  pSrcInfo: PD3DXImageInfo): HResult; stdcall; {name 'D3DXLoadVolumeFromFileA';}
...
D3DXLoadVolumeFromResource: function (
  ...
  Filter: DWord;
  ColorKey: TD3DColor;
  pSrcInfo: PD3DXImageInfo): HResult; stdcall; {name 'D3DXLoadVolumeFromResourceA';}
...
D3DXSaveVolumeToFile: function (
  ...
  pSrcVolume: IDirect3DVolume9;
  pSrcPalette: PPaletteEntry;
  pSrcBox: TD3DBox): HResult; stdcall; {name 'D3DXSaveVolumeToFileA';}
...
D3DXCreateTextureFromFile: function (
  Device: IDirect3DDevice9;
  pSrcFile: PChar;
  out ppTexture: IDirect3DTexture9): HResult; stdcall; {name 'D3DXCreateTextureFromFileA';}
...
D3DXCreateCubeTextureFromFile: function (
  Device: IDirect3DDevice9;
  pSrcFile: PChar;
  out ppCubeTexture: IDirect3DCubeTexture9): HResult; stdcall; {name 'D3DXCreateCubeTextureFromFileA';}
...
D3DXCreateVolumeTextureFromFile: function (
  Device: IDirect3DDevice9;
  pSrcFile: PChar;
  out ppVolumeTexture: IDirect3DVolumeTexture9): HResult; stdcall; {name 'D3DXCreateVolumeTextureFromFileA';}
...
D3DXCreateTextureFromResource: function (
  ...
  hSrcModule: HModule;
  pSrcResource: PChar;
  out ppTexture: IDirect3DTexture9): HResult; stdcall; {name 'D3DXCreateTextureFromResourceA';}
...
D3DXCreateCubeTextureFromResource: function (
  ...
  hSrcModule: HModule;
  pSrcResource: PChar;
  out ppCubeTexture: IDirect3DCubeTexture9): HResult; stdcall; {name 'D3DXCreateCubeTextureFromResourceA';}
...
D3DXCreateVolumeTextureFromResource: function (
  ...
  hSrcModule: HModule;
  pSrcResource: PChar;
  out ppVolumeTexture: IDirect3DVolumeTexture9): HResult; stdcall; {name 'D3DXCreateVolumeTextureFromResourceA';}
...
D3DXCreateTextureFromFileEx: function (
  ...
  pSrcInfo: PD3DXImageInfo;
  pPalette: PPaletteEntry;
  out ppTexture: IDirect3DTexture9): HResult; stdcall; {name 'D3DXCreateTextureFromFileExA';}
...
D3DXCreateCubeTextureFromFileEx: function (
  ...
  pSrcInfo: PD3DXImageInfo;
  pPalette: PPaletteEntry;
  out ppCubeTexture: IDirect3DCubeTexture9): HResult; stdcall; {name 'D3DXCreateCubeTextureFromFileExA';}
...
D3DXCreateVolumeTextureFromFileEx: function (
  ...
  pSrcInfo: PD3DXImageInfo;
  pPalette: PPaletteEntry;
  out ppVolumeTexture: IDirect3DVolumeTexture9): HResult; stdcall;{ name 'D3DXCreateVolumeTextureFromFileExA';}
...
D3DXCreateTextureFromResourceEx: function (
  ...
  pSrcInfo: PD3DXImageInfo;
  pPalette: PPaletteEntry;
  out ppTexture: IDirect3DTexture9): HResult; stdcall; {name 'D3DXCreateTextureFromResourceExA';}
...
D3DXCreateCubeTextureFromResourceEx: function (
  ...
  pSrcInfo: PD3DXImageInfo;
  pPalette: PPaletteEntry;
  out ppCubeTexture: IDirect3DCubeTexture9): HResult; stdcall; {name 'D3DXCreateCubeTextureFromResourceExA';}
...
D3DXCreateVolumeTextureFromResourceEx: function (
  ...
  pSrcInfo: PD3DXImageInfo;
  pPalette: PPaletteEntry;
  out ppVolumeTexture: IDirect3DVolumeTexture9): HResult; stdcall; {name 'D3DXCreateVolumeTextureFromResourceExA';}
...
D3DXSaveTextureToFile: function (
  ...
  DestFormat: TD3DXImageFileFormat;
  pSrcTexture: IDirect3DBaseTexture9;
  pSrcPalette: PPaletteEntry): HResult; stdcall; {name 'D3DXSaveTextureToFileA';}
...
D3DXFilterCubeTexture: function (
  ...
  pPalette: PPaletteEntry;
  SrcLevel: LongWord;
  Filter: DWord): HResult; stdcall; {name 'D3DXFilterTexture';}
...
D3DXFillTextureTX: function (
  pTexture: IDirect3DTexture9;
  pTextureShader: ID3DXTextureShader): HResult; stdcall;
...
//----------------------------------------------------------------------------
var
D3DXLoadMeshHierarchyFromXA: function (
  Filename: PAnsiChar;
  MeshOptions: DWORD;
  pD3DDevice: IDirect3DDevice9;
...
D3DXLoadMeshHierarchyFromXW: function (
  Filename: PWideChar;
  MeshOptions: DWORD;
  pD3DDevice: IDirect3DDevice9;
  pAlloc: ID3DXAllocateHierarchy;
...
D3DXLoadMeshHierarchyFromX: function (
  ...
  pUserDataLoader: ID3DXLoadUserData;
  out ppFrameHierarchy: PD3DXFrame;
  out ppAnimController: ID3DXAnimationController): HResult; stdcall; {name 'D3DXLoadMeshHierarchyFromXA';}
...
D3DXSaveMeshHierarchyToFile: function (
  ...
  pFrameRoot: PD3DXFrame;
  pAnimcontroller: ID3DXAnimationController;
  pUserDataSaver: ID3DXSaveUserData): HResult; stdcall; {name 'D3DXSaveMeshHierarchyToFileA';}
...
D3DXFrameDestroy: function (
  pFrameRoot: PD3DXFrame;
  pAlloc: ID3DXAllocateHierarchy): HResult; stdcall;
...
D3DXFrameAppendChild: function (
  ...
  pFrameChild: PD3DXFrame): HResult; stdcall;
...
D3DXFrameFind: function (
  pFrameRoot: PD3DXFrame;
  Name: PAnsiChar): PD3DXFrame; stdcall;
...
D3DXFrameRegisterNamedMatrices: function (
  pFrameRoot: PD3DXFrame;
  pAnimController: ID3DXAnimationController): HResult; stdcall;
...
D3DXFrameNumNamedMatrices: function (
  pFrameRoot: PD3DXFrame): HResult; stdcall;
...
D3DXFrameCalculateBoundingSphere: function (
  ...
  out pObjectRadius: Single): HResult; stdcall;
...
D3DXCreateKeyframedAnimationSet: function (
  ...
  out ppAnimationSet: ID3DXKeyframedAnimationSet): HResult; stdcall;
...
D3DXCreateCompressedAnimationSet: function (
  ...
  NumCallbackKeys: LongWord;
  pCallbackKeys: PD3DXKeyCallback;
  out ppAnimationSet: ID3DXCompressedAnimationSet): HResult; stdcall;
...
begin
  ...
  hh1:=loadLibrary( d3dx9dll );
  result:=(hh1<>0);
  if not result then exit;


  D3DXCreateAnimationController := getProc(hh1,'D3DXCreateAnimationController');
  D3DXCreateCompressedAnimationSet := getProc(hh1,'D3DXCreateCompressedAnimationSet');
  D3DXCreateKeyframedAnimationSet := getProc(hh1,'D3DXCreateKeyframedAnimationSet');
  D3DXFrameCalculateBoundingSphere := getProc(hh1,'D3DXFrameCalculateBoundingSphere');
  D3DXFrameNumNamedMatrices := getProc(hh1,'D3DXFrameNumNamedMatrices');
  D3DXFrameRegisterNamedMatrices := getProc(hh1,'D3DXFrameRegisterNamedMatrices');
  D3DXFrameFind := getProc(hh1,'D3DXFrameFind');
  D3DXFrameAppendChild := getProc(hh1,'D3DXFrameAppendChild');
  D3DXFrameDestroy := getProc(hh1,'D3DXFrameDestroy');
  D3DXSaveMeshHierarchyToFile := getProc(hh1,'D3DXSaveMeshHierarchyToFileA');
  D3DXSaveMeshHierarchyToFileW := getProc(hh1,'D3DXSaveMeshHierarchyToFileW');
  D3DXSaveMeshHierarchyToFileA := getProc(hh1,'D3DXSaveMeshHierarchyToFileA');
  D3DXLoadMeshHierarchyFromXInMemory := getProc(hh1,'D3DXLoadMeshHierarchyFromXInMemory');
  D3DXLoadMeshHierarchyFromX := getProc(hh1,'D3DXLoadMeshHierarchyFromXA');
  D3DXLoadMeshHierarchyFromXW := getProc(hh1,'D3DXLoadMeshHierarchyFromXW');
  D3DXLoadMeshHierarchyFromXA := getProc(hh1,'D3DXLoadMeshHierarchyFromXA');
  D3DXComputeNormalMap := getProc(hh1,'D3DXComputeNormalMap');
  D3DXFillVolumeTextureTX := getProc(hh1,'D3DXFillVolumeTextureTX');
  D3DXFillCubeTextureTX := getProc(hh1,'D3DXFillCubeTextureTX');
  D3DXFillTextureTX := getProc(hh1,'D3DXFillTextureTX');
  D3DXFillVolumeTexture := getProc(hh1,'D3DXFillVolumeTexture');
  D3DXFillCubeTexture := getProc(hh1,'D3DXFillCubeTexture');
  D3DXFillTexture := getProc(hh1,'D3DXFillTexture');
  D3DXFilterVolumeTexture := getProc(hh1,'D3DXFilterTexture');
  D3DXFilterCubeTexture := getProc(hh1,'D3DXFilterTexture');
  D3DXFilterTexture := getProc(hh1,'D3DXFilterTexture');
  D3DXSaveTextureToFileInMemory := getProc(hh1,'D3DXSaveTextureToFileInMemory');
  D3DXSaveTextureToFile := getProc(hh1,'D3DXSaveTextureToFileA');
  D3DXSaveTextureToFileW := getProc(hh1,'D3DXSaveTextureToFileW');
  D3DXSaveTextureToFileA := getProc(hh1,'D3DXSaveTextureToFileA');
  D3DXCreateVolumeTextureFromFileInMemoryEx := getProc(hh1,'D3DXCreateVolumeTextureFromFileInMemoryEx');
  D3DXCreateCubeTextureFromFileInMemoryEx := getProc(hh1,'D3DXCreateCubeTextureFromFileInMemoryEx');
  D3DXCreateTextureFromFileInMemoryEx := getProc(hh1,'D3DXCreateTextureFromFileInMemoryEx');
  D3DXCreateVolumeTextureFromFileInMemory := getProc(hh1,'D3DXCreateVolumeTextureFromFileInMemory');
  D3DXCreateCubeTextureFromFileInMemory := getProc(hh1,'D3DXCreateCubeTextureFromFileInMemory');
  D3DXCreateTextureFromFileInMemory := getProc(hh1,'D3DXCreateTextureFromFileInMemory');
  D3DXCreateVolumeTextureFromResourceEx := getProc(hh1,'D3DXCreateVolumeTextureFromResourceExA');
  D3DXCreateVolumeTextureFromResourceExW := getProc(hh1,'D3DXCreateVolumeTextureFromResourceExW');
  D3DXCreateVolumeTextureFromResourceExA := getProc(hh1,'D3DXCreateVolumeTextureFromResourceExA');
  D3DXCreateCubeTextureFromResourceEx := getProc(hh1,'D3DXCreateCubeTextureFromResourceExA');
  D3DXCreateCubeTextureFromResourceExW := getProc(hh1,'D3DXCreateCubeTextureFromResourceExW');
  D3DXCreateCubeTextureFromResourceExA := getProc(hh1,'D3DXCreateCubeTextureFromResourceExA');
  D3DXCreateTextureFromResourceEx := getProc(hh1,'D3DXCreateTextureFromResourceExA');
  D3DXCreateTextureFromResourceExW := getProc(hh1,'D3DXCreateTextureFromResourceExW');
  D3DXCreateTextureFromResourceExA := getProc(hh1,'D3DXCreateTextureFromResourceExA');
  D3DXCreateVolumeTextureFromFileEx := getProc(hh1,'D3DXCreateVolumeTextureFromFileExA');
  D3DXCreateVolumeTextureFromFileExW := getProc(hh1,'D3DXCreateVolumeTextureFromFileExW');
  D3DXCreateVolumeTextureFromFileExA := getProc(hh1,'D3DXCreateVolumeTextureFromFileExA');
  D3DXCreateCubeTextureFromFileEx := getProc(hh1,'D3DXCreateCubeTextureFromFileExA');
  D3DXCreateCubeTextureFromFileExW := getProc(hh1,'D3DXCreateCubeTextureFromFileExW');
  D3DXCreateCubeTextureFromFileExA := getProc(hh1,'D3DXCreateCubeTextureFromFileExA');
  D3DXCreateTextureFromFileEx := getProc(hh1,'D3DXCreateTextureFromFileExA');
  D3DXCreateTextureFromFileExW := getProc(hh1,'D3DXCreateTextureFromFileExW');
  D3DXCreateTextureFromFileExA := getProc(hh1,'D3DXCreateTextureFromFileExA');
  D3DXCreateVolumeTextureFromResource := getProc(hh1,'D3DXCreateVolumeTextureFromResourceA');
  D3DXCreateVolumeTextureFromResourceW := getProc(hh1,'D3DXCreateVolumeTextureFromResourceW');
  D3DXCreateVolumeTextureFromResourceA := getProc(hh1,'D3DXCreateVolumeTextureFromResourceA');
  D3DXCreateCubeTextureFromResource := getProc(hh1,'D3DXCreateCubeTextureFromResourceA');
  D3DXCreateCubeTextureFromResourceW := getProc(hh1,'D3DXCreateCubeTextureFromResourceW');
  D3DXCreateCubeTextureFromResourceA := getProc(hh1,'D3DXCreateCubeTextureFromResourceA');
  D3DXCreateTextureFromResource := getProc(hh1,'D3DXCreateTextureFromResourceA');
  D3DXCreateTextureFromResourceW := getProc(hh1,'D3DXCreateTextureFromResourceW');
  D3DXCreateTextureFromResourceA := getProc(hh1,'D3DXCreateTextureFromResourceA');
  D3DXCreateVolumeTextureFromFile := getProc(hh1,'D3DXCreateVolumeTextureFromFileA');
  D3DXCreateVolumeTextureFromFileW := getProc(hh1,'D3DXCreateVolumeTextureFromFileW');
  D3DXCreateVolumeTextureFromFileA := getProc(hh1,'D3DXCreateVolumeTextureFromFileA');
  D3DXCreateCubeTextureFromFile := getProc(hh1,'D3DXCreateCubeTextureFromFileA');
  D3DXCreateCubeTextureFromFileW := getProc(hh1,'D3DXCreateCubeTextureFromFileW');
  D3DXCreateCubeTextureFromFileA := getProc(hh1,'D3DXCreateCubeTextureFromFileA');
  D3DXCreateTextureFromFile := getProc(hh1,'D3DXCreateTextureFromFileA');
  D3DXCreateTextureFromFileW := getProc(hh1,'D3DXCreateTextureFromFileW');
  D3DXCreateTextureFromFileA := getProc(hh1,'D3DXCreateTextureFromFileA');
  D3DXCreateVolumeTexture := getProc(hh1,'D3DXCreateVolumeTexture');
  D3DXCreateCubeTexture := getProc(hh1,'D3DXCreateCubeTexture');
  D3DXCreateTexture := getProc(hh1,'D3DXCreateTexture');
  D3DXCheckVolumeTextureRequirements := getProc(hh1,'D3DXCheckVolumeTextureRequirements');
  D3DXCheckCubeTextureRequirements := getProc(hh1,'D3DXCheckCubeTextureRequirements');
  D3DXCheckTextureRequirements := getProc(hh1,'D3DXCheckTextureRequirements');
  D3DXSaveVolumeToFileInMemory := getProc(hh1,'D3DXSaveVolumeToFileInMemory');
  D3DXSaveVolumeToFile := getProc(hh1,'D3DXSaveVolumeToFileA');
  D3DXSaveVolumeToFileW := getProc(hh1,'D3DXSaveVolumeToFileW');
  D3DXSaveVolumeToFileA := getProc(hh1,'D3DXSaveVolumeToFileA');
  D3DXLoadVolumeFromMemory := getProc(hh1,'D3DXLoadVolumeFromMemory');
  D3DXLoadVolumeFromVolume := getProc(hh1,'D3DXLoadVolumeFromVolume');
  D3DXLoadVolumeFromFileInMemory := getProc(hh1,'D3DXLoadVolumeFromFileInMemory');
  D3DXLoadVolumeFromResource := getProc(hh1,'D3DXLoadVolumeFromResourceA');
  D3DXLoadVolumeFromResourceW := getProc(hh1,'D3DXLoadVolumeFromResourceW');
  D3DXLoadVolumeFromResourceA := getProc(hh1,'D3DXLoadVolumeFromResourceA');
  D3DXLoadVolumeFromFile := getProc(hh1,'D3DXLoadVolumeFromFileA');
  D3DXLoadVolumeFromFileW := getProc(hh1,'D3DXLoadVolumeFromFileW');
  D3DXLoadVolumeFromFileA := getProc(hh1,'D3DXLoadVolumeFromFileA');
  D3DXSaveSurfaceToFileInMemory := getProc(hh1,'D3DXSaveSurfaceToFileInMemory');
  D3DXSaveSurfaceToFile := getProc(hh1,'D3DXSaveSurfaceToFileA');
  D3DXSaveSurfaceToFileW := getProc(hh1,'D3DXSaveSurfaceToFileW');
  D3DXSaveSurfaceToFileA := getProc(hh1,'D3DXSaveSurfaceToFileA');
  D3DXLoadSurfaceFromMemory := getProc(hh1,'D3DXLoadSurfaceFromMemory');
  D3DXLoadSurfaceFromSurface := getProc(hh1,'D3DXLoadSurfaceFromSurface');
  D3DXLoadSurfaceFromFileInMemory := getProc(hh1,'D3DXLoadSurfaceFromFileInMemory');
  D3DXLoadSurfaceFromResource := getProc(hh1,'D3DXLoadSurfaceFromResourceA');
  D3DXLoadSurfaceFromResourceW := getProc(hh1,'D3DXLoadSurfaceFromResourceW');
  D3DXLoadSurfaceFromResourceA := getProc(hh1,'D3DXLoadSurfaceFromResourceA');
  D3DXLoadSurfaceFromFile := getProc(hh1,'D3DXLoadSurfaceFromFileA');
  D3DXLoadSurfaceFromFileW := getProc(hh1,'D3DXLoadSurfaceFromFileW');
  D3DXLoadSurfaceFromFileA := getProc(hh1,'D3DXLoadSurfaceFromFileA');
  D3DXGetImageInfoFromFileInMemory := getProc(hh1,'D3DXGetImageInfoFromFileInMemory');
  D3DXGetImageInfoFromResource := getProc(hh1,'D3DXGetImageInfoFromResourceA');
  D3DXGetImageInfoFromResourceW := getProc(hh1,'D3DXGetImageInfoFromResourceW');
  D3DXGetImageInfoFromResourceA := getProc(hh1,'D3DXGetImageInfoFromResourceA');
  D3DXGetImageInfoFromFile := getProc(hh1,'D3DXGetImageInfoFromFileA');
  D3DXGetImageInfoFromFileW := getProc(hh1,'D3DXGetImageInfoFromFileW');
  D3DXGetImageInfoFromFileA := getProc(hh1,'D3DXGetImageInfoFromFileA');
  D3DXCreateText := getProc(hh1,'D3DXCreateTextA');
  D3DXCreateTextW := getProc(hh1,'D3DXCreateTextW');
  D3DXCreateTextA := getProc(hh1,'D3DXCreateTextA');
  D3DXCreateTeapot := getProc(hh1,'D3DXCreateTeapot');
  D3DXCreateTorus := getProc(hh1,'D3DXCreateTorus');
  D3DXCreateSphere := getProc(hh1,'D3DXCreateSphere');
  D3DXCreateCylinder := getProc(hh1,'D3DXCreateCylinder');
  D3DXCreateBox := getProc(hh1,'D3DXCreateBox');
  D3DXCreatePolygon := getProc(hh1,'D3DXCreatePolygon');
  D3DXSHPRTCompSplitMeshSC := getProc(hh1,'D3DXSHPRTCompSplitMeshSC');
  D3DXSHPRTCompSuperCluster := getProc(hh1,'D3DXSHPRTCompSuperCluster');
  D3DXConcatenateMeshes := getProc(hh1,'D3DXConcatenateMeshes');
  D3DXCreatePRTEngine := getProc(hh1,'D3DXCreatePRTEngine');
  D3DXCreateTextureGutterHelper := getProc(hh1,'D3DXCreateTextureGutterHelper');
  D3DXCreatePRTCompBuffer := getProc(hh1,'D3DXCreatePRTCompBuffer');
  D3DXSavePRTCompBufferToFile := getProc(hh1,'D3DXSavePRTCompBufferToFileA');
  D3DXSavePRTCompBufferToFileW := getProc(hh1,'D3DXSavePRTCompBufferToFileW');
  D3DXSavePRTCompBufferToFileA := getProc(hh1,'D3DXSavePRTCompBufferToFileA');
  D3DXLoadPRTCompBufferFromFile := getProc(hh1,'D3DXLoadPRTCompBufferFromFileA');
  D3DXLoadPRTCompBufferFromFileW := getProc(hh1,'D3DXLoadPRTCompBufferFromFileW');
  D3DXLoadPRTCompBufferFromFileA := getProc(hh1,'D3DXLoadPRTCompBufferFromFileA');
  D3DXSavePRTBufferToFile := getProc(hh1,'D3DXSavePRTBufferToFileA');
  D3DXSavePRTBufferToFileW := getProc(hh1,'D3DXSavePRTBufferToFileW');
  D3DXSavePRTBufferToFileA := getProc(hh1,'D3DXSavePRTBufferToFileA');
  D3DXLoadPRTBufferFromFile := getProc(hh1,'D3DXLoadPRTBufferFromFileA');
  D3DXLoadPRTBufferFromFileW := getProc(hh1,'D3DXLoadPRTBufferFromFileW');
  D3DXLoadPRTBufferFromFileA := getProc(hh1,'D3DXLoadPRTBufferFromFileA');
  D3DXCreatePRTBufferTex := getProc(hh1,'D3DXCreatePRTBufferTex');
  D3DXCreatePRTBuffer := getProc(hh1,'D3DXCreatePRTBuffer');
  D3DXOptimizeVertices := getProc(hh1,'D3DXOptimizeVertices');
  D3DXOptimizeFaces := getProc(hh1,'D3DXOptimizeFaces');
  D3DXConvertMeshSubsetToStrips := getProc(hh1,'D3DXConvertMeshSubsetToStrips');
  D3DXConvertMeshSubsetToSingleStrip := getProc(hh1,'D3DXConvertMeshSubsetToSingleStrip');
  D3DXComputeIMTFromPerTexelSignal := getProc(hh1,'D3DXComputeIMTFromPerTexelSignal');
  D3DXComputeIMTFromTexture := getProc(hh1,'D3DXComputeIMTFromTexture');
  D3DXComputeIMTFromSignal := getProc(hh1,'D3DXComputeIMTFromSignal');
  D3DXComputeIMTFromPerVertexSignal := getProc(hh1,'D3DXComputeIMTFromPerVertexSignal');
  D3DXUVAtlasPack := getProc(hh1,'D3DXUVAtlasPack');
  D3DXUVAtlasPartition := getProc(hh1,'D3DXUVAtlasPartition');
  D3DXUVAtlasCreate := getProc(hh1,'D3DXUVAtlasCreate');
  D3DXComputeTangent := getProc(hh1,'D3DXComputeTangent');
  D3DXComputeTangentFrameEx := getProc(hh1,'D3DXComputeTangentFrameEx');
  D3DXComputeTangentFrame := getProc(hh1,'D3DXComputeTangentFrame');
  D3DXBoxBoundProbe := getProc(hh1,'D3DXBoxBoundProbe');
  D3DXSphereBoundProbe := getProc(hh1,'D3DXSphereBoundProbe');
  D3DXIntersectTri := getProc(hh1,'D3DXIntersectTri');
  D3DXSplitMesh := getProc(hh1,'D3DXSplitMesh');
  D3DXIntersectSubset := getProc(hh1,'D3DXIntersectSubset');
  D3DXIntersect := getProc(hh1,'D3DXIntersect');
  D3DXWeldVertices := getProc(hh1,'D3DXWeldVertices');
  D3DXFVFFromDeclarator := getProc(hh1,'D3DXFVFFromDeclarator');
  D3DXDeclaratorFromFVF := getProc(hh1,'D3DXDeclaratorFromFVF');
  D3DXGetDeclLength := getProc(hh1,'D3DXGetDeclLength');
  D3DXGetDeclVertexSize := getProc(hh1,'D3DXGetDeclVertexSize');
  D3DXGetFVFVertexSize := getProc(hh1,'D3DXGetFVFVertexSize');
  D3DXValidPatchMesh := getProc(hh1,'D3DXValidPatchMesh');
  D3DXCreatePatchMesh := getProc(hh1,'D3DXCreatePatchMesh');
  D3DXCreateNPatchMesh := getProc(hh1,'D3DXCreateNPatchMesh');
  D3DXTessellateTriPatch := getProc(hh1,'D3DXTessellateTriPatch');
  D3DXTessellateRectPatch := getProc(hh1,'D3DXTessellateRectPatch');
  D3DXTriPatchSize := getProc(hh1,'D3DXTriPatchSize');
  D3DXRectPatchSize := getProc(hh1,'D3DXRectPatchSize');
  D3DXLoadPatchMeshFromXof := getProc(hh1,'D3DXLoadPatchMeshFromXof');
  D3DXGenerateOutputDecl := getProc(hh1,'D3DXGenerateOutputDecl');
  D3DXTessellateNPatches := getProc(hh1,'D3DXTessellateNPatches');
  D3DXCreateSkinInfoFromBlendedMesh := getProc(hh1,'D3DXCreateSkinInfoFromBlendedMesh');
  D3DXLoadSkinMeshFromXof := getProc(hh1,'D3DXLoadSkinMeshFromXof');
  D3DXLoadMeshFromXof := getProc(hh1,'D3DXLoadMeshFromXof');
  D3DXCreateSkinInfoFVF := getProc(hh1,'D3DXCreateSkinInfoFVF');
  D3DXCreateSkinInfo := getProc(hh1,'D3DXCreateSkinInfo');
  D3DXCreatePMeshFromStream := getProc(hh1,'D3DXCreatePMeshFromStream');
  D3DXSaveMeshToX := getProc(hh1,'D3DXSaveMeshToXA');
  D3DXSaveMeshToXW := getProc(hh1,'D3DXSaveMeshToXW');
  D3DXSaveMeshToXA := getProc(hh1,'D3DXSaveMeshToXA');
  D3DXLoadMeshFromXResource := getProc(hh1,'D3DXLoadMeshFromXResource');
  D3DXLoadMeshFromXInMemory := getProc(hh1,'D3DXLoadMeshFromXInMemory');
  D3DXLoadMeshFromX := getProc(hh1,'D3DXLoadMeshFromXA');
  D3DXLoadMeshFromXW := getProc(hh1,'D3DXLoadMeshFromXW');
  D3DXLoadMeshFromXA := getProc(hh1,'D3DXLoadMeshFromXA');
  D3DXCreateBuffer := getProc(hh1,'D3DXCreateBuffer');
  D3DXComputeNormals := getProc(hh1,'D3DXComputeNormals');
  D3DXComputeBoundingBox := getProc(hh1,'D3DXComputeBoundingBox');
  D3DXComputeBoundingSphere := getProc(hh1,'D3DXComputeBoundingSphere');
  D3DXSimplifyMesh := getProc(hh1,'D3DXSimplifyMesh');
  D3DXGeneratePMesh := getProc(hh1,'D3DXGeneratePMesh');
  D3DXValidMesh := getProc(hh1,'D3DXValidMesh');
  D3DXCleanMesh := getProc(hh1,'D3DXCleanMesh');
  D3DXCreateSPMesh := getProc(hh1,'D3DXCreateSPMesh');
  D3DXCreateMeshFVF := getProc(hh1,'D3DXCreateMeshFVF');
  D3DXCreateMesh := getProc(hh1,'D3DXCreateMesh');
  D3DXFileCreate := getProc(hh1,'D3DXFileCreate');
  D3DXDisassembleEffect := getProc(hh1,'D3DXDisassembleEffect');
  D3DXCreateEffectCompiler := getProc(hh1,'D3DXCreateEffectCompiler');
  D3DXCreateEffectCompilerFromResource := getProc(hh1,'D3DXCreateEffectCompilerFromResourceA');
  D3DXCreateEffectCompilerFromResourceW := getProc(hh1,'D3DXCreateEffectCompilerFromResourceW');
  D3DXCreateEffectCompilerFromResourceA := getProc(hh1,'D3DXCreateEffectCompilerFromResourceA');
  D3DXCreateEffectCompilerFromFile := getProc(hh1,'D3DXCreateEffectCompilerFromFileA');
  D3DXCreateEffectCompilerFromFileW := getProc(hh1,'D3DXCreateEffectCompilerFromFileW');
  D3DXCreateEffectCompilerFromFileA := getProc(hh1,'D3DXCreateEffectCompilerFromFileA');
  D3DXCreateEffectEx := getProc(hh1,'D3DXCreateEffectEx');
  D3DXCreateEffectFromResourceEx := getProc(hh1,'D3DXCreateEffectFromResourceExA');
  D3DXCreateEffectFromResourceExW := getProc(hh1,'D3DXCreateEffectFromResourceExW');
  D3DXCreateEffectFromResourceExA := getProc(hh1,'D3DXCreateEffectFromResourceExA');
  D3DXCreateEffectFromFileEx := getProc(hh1,'D3DXCreateEffectFromFileExA');
  D3DXCreateEffectFromFileExW := getProc(hh1,'D3DXCreateEffectFromFileExW');
  D3DXCreateEffectFromFileExA := getProc(hh1,'D3DXCreateEffectFromFileExA');
  D3DXCreateEffect := getProc(hh1,'D3DXCreateEffect');
  D3DXCreateEffectFromResource := getProc(hh1,'D3DXCreateEffectFromResourceA');
  D3DXCreateEffectFromResourceW := getProc(hh1,'D3DXCreateEffectFromResourceW');
  D3DXCreateEffectFromResourceA := getProc(hh1,'D3DXCreateEffectFromResourceA');
  D3DXCreateEffectFromFile := getProc(hh1,'D3DXCreateEffectFromFileA');
  D3DXCreateEffectFromFileW := getProc(hh1,'D3DXCreateEffectFromFileW');
  D3DXCreateEffectFromFileA := getProc(hh1,'D3DXCreateEffectFromFileA');
  D3DXCreateEffectPool := getProc(hh1,'D3DXCreateEffectPool');
  D3DXPreprocessShader := getProc(hh1,'D3DXPreprocessShader');
  D3DXPreprocessShaderFromResourceW := getProc(hh1,'D3DXPreprocessShaderFromResourceW');
  D3DXPreprocessShaderFromResource := getProc(hh1,'D3DXPreprocessShaderFromResourceA');
  D3DXPreprocessShaderFromResourceA := getProc(hh1,'D3DXPreprocessShaderFromResourceA');
  D3DXPreprocessShaderFromFile := getProc(hh1,'D3DXPreprocessShaderFromFileA');
  D3DXPreprocessShaderFromFileW := getProc(hh1,'D3DXPreprocessShaderFromFileW');
  D3DXPreprocessShaderFromFileA := getProc(hh1,'D3DXPreprocessShaderFromFileA');
  D3DXCreateFragmentLinker := getProc(hh1,'D3DXCreateFragmentLinker');
  D3DXGatherFragments := getProc(hh1,'D3DXGatherFragments');
  D3DXGatherFragmentsFromResource := getProc(hh1,'D3DXGatherFragmentsFromResourceA');
  D3DXGatherFragmentsFromResourceW := getProc(hh1,'D3DXGatherFragmentsFromResourceW');
  D3DXGatherFragmentsFromResourceA := getProc(hh1,'D3DXGatherFragmentsFromResourceA');
  D3DXGatherFragmentsFromFile := getProc(hh1,'D3DXGatherFragmentsFromFileA');
  D3DXGatherFragmentsFromFileW := getProc(hh1,'D3DXGatherFragmentsFromFileW');
  D3DXGatherFragmentsFromFileA := getProc(hh1,'D3DXGatherFragmentsFromFileA');
  D3DXCreateTextureShader := getProc(hh1,'D3DXCreateTextureShader');
  D3DXGetShaderConstantTable := getProc(hh1,'D3DXGetShaderConstantTable');
  D3DXGetShaderSamplers := getProc(hh1,'D3DXGetShaderSamplers');
  D3DXGetShaderOutputSemantics := getProc(hh1,'D3DXGetShaderOutputSemantics');
  D3DXGetShaderInputSemantics := getProc(hh1,'D3DXGetShaderInputSemantics');
  D3DXGetShaderVersion := getProc(hh1,'D3DXGetShaderVersion');
  D3DXGetShaderSize := getProc(hh1,'D3DXGetShaderSize');
  D3DXFindShaderComment := getProc(hh1,'D3DXFindShaderComment');
  D3DXGetVertexShaderProfile := getProc(hh1,'D3DXGetVertexShaderProfile');
  D3DXGetPixelShaderProfile := getProc(hh1,'D3DXGetPixelShaderProfile');
  D3DXDisassembleShader := getProc(hh1,'D3DXDisassembleShader');
  D3DXCompileShader := getProc(hh1,'D3DXCompileShader');
  D3DXCompileShaderFromResource := getProc(hh1,'D3DXCompileShaderFromResourceA');
  D3DXCompileShaderFromResourceW := getProc(hh1,'D3DXCompileShaderFromResourceW');
  D3DXCompileShaderFromResourceA := getProc(hh1,'D3DXCompileShaderFromResourceA');
  D3DXCompileShaderFromFile := getProc(hh1,'D3DXCompileShaderFromFileA');
  D3DXCompileShaderFromFileW := getProc(hh1,'D3DXCompileShaderFromFileW');
  D3DXCompileShaderFromFileA := getProc(hh1,'D3DXCompileShaderFromFileA');
  D3DXAssembleShader := getProc(hh1,'D3DXAssembleShader');
  D3DXAssembleShaderFromResource := getProc(hh1,'D3DXAssembleShaderFromResourceA');
  D3DXAssembleShaderFromResourceW := getProc(hh1,'D3DXAssembleShaderFromResourceW');
  D3DXAssembleShaderFromResourceA := getProc(hh1,'D3DXAssembleShaderFromResourceA');
  D3DXAssembleShaderFromFile := getProc(hh1,'D3DXAssembleShaderFromFileA');
  D3DXAssembleShaderFromFileW := getProc(hh1,'D3DXAssembleShaderFromFileW');
  D3DXAssembleShaderFromFileA := getProc(hh1,'D3DXAssembleShaderFromFileA');
  D3DXCreateLine := getProc(hh1,'D3DXCreateLine');
  D3DXCreateRenderToEnvMap := getProc(hh1,'D3DXCreateRenderToEnvMap');
  D3DXCreateRenderToSurface := getProc(hh1,'D3DXCreateRenderToSurface');
  D3DXCreateFontIndirect := getProc(hh1,'D3DXCreateFontIndirectA');
  D3DXCreateFontIndirectW := getProc(hh1,'D3DXCreateFontIndirectW');
  D3DXCreateFont := getProc(hh1,'D3DXCreateFontA');
  D3DXCreateFontIndirectA := getProc(hh1,'D3DXCreateFontIndirectA');
  D3DXCreateFontW := getProc(hh1,'D3DXCreateFontW');
  D3DXCreateFontA := getProc(hh1,'D3DXCreateFontA');
  D3DXCreateSprite := getProc(hh1,'D3DXCreateSprite');
  D3DXGetDriverLevel := getProc(hh1,'D3DXGetDriverLevel');
  D3DXDebugMute := getProc(hh1,'D3DXDebugMute');
  D3DXCheckVersion := getProc(hh1,'D3DXCheckVersion');
  D3DXSHProjectCubeMap := getProc(hh1,'D3DXSHProjectCubeMap');
  D3DXSHEvalHemisphereLight := getProc(hh1,'D3DXSHEvalHemisphereLight');
  D3DXSHEvalConeLight := getProc(hh1,'D3DXSHEvalConeLight');
  D3DXSHEvalSphericalLight := getProc(hh1,'D3DXSHEvalSphericalLight');
  D3DXSHEvalDirectionalLight := getProc(hh1,'D3DXSHEvalDirectionalLight');
  D3DXSHMultiply6 := getProc(hh1,'D3DXSHMultiply6');
  D3DXSHMultiply5 := getProc(hh1,'D3DXSHMultiply5');
  D3DXSHMultiply4 := getProc(hh1,'D3DXSHMultiply4');
  D3DXSHMultiply3 := getProc(hh1,'D3DXSHMultiply3');
  D3DXSHMultiply2 := getProc(hh1,'D3DXSHMultiply2');
  D3DXSHDot := getProc(hh1,'D3DXSHDot');
  D3DXSHScale := getProc(hh1,'D3DXSHScale');
  D3DXSHAdd := getProc(hh1,'D3DXSHAdd');
  D3DXSHRotateZ := getProc(hh1,'D3DXSHRotateZ');
  D3DXSHRotate := getProc(hh1,'D3DXSHRotate');
  D3DXSHEvalDirection := getProc(hh1,'D3DXSHEvalDirection');
  D3DXCreateMatrixStack := getProc(hh1,'D3DXCreateMatrixStack');
  D3DXFresnelTerm := getProc(hh1,'D3DXFresnelTerm');
  D3DXColorAdjustContrast := getProc(hh1,'D3DXColorAdjustContrast');
  D3DXColorAdjustSaturation := getProc(hh1,'D3DXColorAdjustSaturation');
  D3DXPlaneTransformArray := getProc(hh1,'D3DXPlaneTransformArray');
  D3DXPlaneTransform := getProc(hh1,'D3DXPlaneTransform');
  D3DXPlaneFromPoints := getProc(hh1,'D3DXPlaneFromPoints');
  D3DXPlaneFromPointNormal := getProc(hh1,'D3DXPlaneFromPointNormal');
  D3DXPlaneIntersectLine := getProc(hh1,'D3DXPlaneIntersectLine');
  D3DXPlaneNormalize := getProc(hh1,'D3DXPlaneNormalize');
  D3DXQuaternionBaryCentric := getProc(hh1,'D3DXQuaternionBaryCentric');
  D3DXQuaternionSquadSetup := getProc(hh1,'D3DXQuaternionSquadSetup');
  D3DXQuaternionSquad := getProc(hh1,'D3DXQuaternionSquad');
  D3DXQuaternionSlerp := getProc(hh1,'D3DXQuaternionSlerp');
  D3DXQuaternionExp := getProc(hh1,'D3DXQuaternionExp');
  D3DXQuaternionLn := getProc(hh1,'D3DXQuaternionLn');
  D3DXQuaternionInverse := getProc(hh1,'D3DXQuaternionInverse');
  D3DXQuaternionNormalize := getProc(hh1,'D3DXQuaternionNormalize');
  D3DXQuaternionMultiply := getProc(hh1,'D3DXQuaternionMultiply');
  D3DXQuaternionRotationYawPitchRoll := getProc(hh1,'D3DXQuaternionRotationYawPitchRoll');
  D3DXQuaternionRotationAxis := getProc(hh1,'D3DXQuaternionRotationAxis');
  D3DXQuaternionRotationMatrix := getProc(hh1,'D3DXQuaternionRotationMatrix');
  D3DXQuaternionToAxisAngle := getProc(hh1,'D3DXQuaternionToAxisAngle');
  D3DXMatrixReflect := getProc(hh1,'D3DXMatrixReflect');
  D3DXMatrixShadow := getProc(hh1,'D3DXMatrixShadow');
  D3DXMatrixOrthoOffCenterLH := getProc(hh1,'D3DXMatrixOrthoOffCenterLH');
  D3DXMatrixOrthoOffCenterRH := getProc(hh1,'D3DXMatrixOrthoOffCenterRH');
  D3DXMatrixOrthoLH := getProc(hh1,'D3DXMatrixOrthoLH');
  D3DXMatrixOrthoRH := getProc(hh1,'D3DXMatrixOrthoRH');
  D3DXMatrixPerspectiveOffCenterLH := getProc(hh1,'D3DXMatrixPerspectiveOffCenterLH');
  D3DXMatrixPerspectiveOffCenterRH := getProc(hh1,'D3DXMatrixPerspectiveOffCenterRH');
  D3DXMatrixPerspectiveFovLH := getProc(hh1,'D3DXMatrixPerspectiveFovLH');
  D3DXMatrixPerspectiveFovRH := getProc(hh1,'D3DXMatrixPerspectiveFovRH');
  D3DXMatrixPerspectiveLH := getProc(hh1,'D3DXMatrixPerspectiveLH');
  D3DXMatrixPerspectiveRH := getProc(hh1,'D3DXMatrixPerspectiveRH');
  D3DXMatrixLookAtLH := getProc(hh1,'D3DXMatrixLookAtLH');
  D3DXMatrixLookAtRH := getProc(hh1,'D3DXMatrixLookAtRH');
  D3DXMatrixAffineTransformation2D := getProc(hh1,'D3DXMatrixAffineTransformation2D');
  D3DXMatrixAffineTransformation := getProc(hh1,'D3DXMatrixAffineTransformation');
  D3DXMatrixTransformation2D := getProc(hh1,'D3DXMatrixTransformation2D');
  D3DXMatrixTransformation := getProc(hh1,'D3DXMatrixTransformation');
  D3DXMatrixRotationYawPitchRoll := getProc(hh1,'D3DXMatrixRotationYawPitchRoll');
  D3DXMatrixRotationQuaternion := getProc(hh1,'D3DXMatrixRotationQuaternion');
  D3DXMatrixRotationAxis := getProc(hh1,'D3DXMatrixRotationAxis');
  D3DXMatrixRotationZ := getProc(hh1,'D3DXMatrixRotationZ');
  D3DXMatrixRotationY := getProc(hh1,'D3DXMatrixRotationY');
  D3DXMatrixRotationX := getProc(hh1,'D3DXMatrixRotationX');
  D3DXMatrixTranslation := getProc(hh1,'D3DXMatrixTranslation');
  D3DXMatrixScaling := getProc(hh1,'D3DXMatrixScaling');
  D3DXMatrixInverse := getProc(hh1,'D3DXMatrixInverse');
  D3DXMatrixMultiplyTranspose := getProc(hh1,'D3DXMatrixMultiplyTranspose');
  D3DXMatrixMultiply := getProc(hh1,'D3DXMatrixMultiply');
  D3DXMatrixTranspose := getProc(hh1,'D3DXMatrixTranspose');
  D3DXMatrixDecompose := getProc(hh1,'D3DXMatrixDecompose');
  D3DXMatrixDeterminant := getProc(hh1,'D3DXMatrixDeterminant');
  D3DXVec4TransformArray := getProc(hh1,'D3DXVec4TransformArray');
  D3DXVec4Transform := getProc(hh1,'D3DXVec4Transform');
  D3DXVec4BaryCentric := getProc(hh1,'D3DXVec4BaryCentric');
  D3DXVec4CatmullRom := getProc(hh1,'D3DXVec4CatmullRom');
  D3DXVec4Hermite := getProc(hh1,'D3DXVec4Hermite');
  D3DXVec4Normalize := getProc(hh1,'D3DXVec4Normalize');
  D3DXVec4Cross := getProc(hh1,'D3DXVec4Cross');
  D3DXVec3UnprojectArray := getProc(hh1,'D3DXVec3UnprojectArray');
  D3DXVec3ProjectArray := getProc(hh1,'D3DXVec3ProjectArray');
  D3DXVec3Unproject := getProc(hh1,'D3DXVec3Unproject');
  D3DXVec3Project := getProc(hh1,'D3DXVec3Project');
  D3DXVec3TransformNormalArray := getProc(hh1,'D3DXVec3TransformNormalArray');
  D3DXVec3TransformCoordArray := getProc(hh1,'D3DXVec3TransformCoordArray');
  D3DXVec3TransformArray := getProc(hh1,'D3DXVec3TransformArray');
  D3DXVec3TransformNormal := getProc(hh1,'D3DXVec3TransformNormal');
  D3DXVec3TransformCoord := getProc(hh1,'D3DXVec3TransformCoord');
  D3DXVec3Transform := getProc(hh1,'D3DXVec3Transform');
  D3DXVec3BaryCentric := getProc(hh1,'D3DXVec3BaryCentric');
  D3DXVec3CatmullRom := getProc(hh1,'D3DXVec3CatmullRom');
  D3DXVec3Hermite := getProc(hh1,'D3DXVec3Hermite');
  D3DXVec3Normalize := getProc(hh1,'D3DXVec3Normalize');
  D3DXVec2TransformNormalArray := getProc(hh1,'D3DXVec2TransformNormalArray');
  D3DXVec2TransformCoordArray := getProc(hh1,'D3DXVec2TransformCoordArray');
  D3DXVec2TransformArray := getProc(hh1,'D3DXVec2TransformArray');
  D3DXVec2TransformNormal := getProc(hh1,'D3DXVec2TransformNormal');
  D3DXVec2TransformCoord := getProc(hh1,'D3DXVec2TransformCoord');
  D3DXVec2Transform := getProc(hh1,'D3DXVec2Transform');
  D3DXVec2BaryCentric := getProc(hh1,'D3DXVec2BaryCentric');
  D3DXVec2CatmullRom := getProc(hh1,'D3DXVec2CatmullRom');
  D3DXVec2Hermite := getProc(hh1,'D3DXVec2Hermite');
  D3DXVec2Normalize := getProc(hh1,'D3DXVec2Normalize');
  D3DXFloat16To32Array := getProc(hh1,'D3DXFloat16To32Array');
  D3DXFloat32To16Array := getProc(hh1,'D3DXFloat32To16Array');

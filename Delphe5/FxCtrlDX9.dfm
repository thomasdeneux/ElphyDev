object FXcontrol: TFXcontrol
  ...
  object MainMenu1: TMainMenu
    ...
    object Stimulation1: TMenuItem
      ...
      object CreateTextureFile1: TMenuItem
        Caption = 'Create Texture File'
        OnClick = CreateTextureFile1Click
      end
    end
    ...
    object Screen1: TMenuItem
      ...
      object SaveasBMP1: TMenuItem
        Caption = 'Save Image'
        object asBMP1: TMenuItem
          Tag = 1
          Caption = 'as BMP'
          OnClick = SaveImageClick
        end
        object asJPEG1: TMenuItem
          Tag = 2
          Caption = 'as JPEG'
          OnClick = SaveImageClick
        end
    ...
    object ools1: TMenuItem
      Caption = 'Tools'
      object BitmapCorrection1: TMenuItem
        Caption = 'Bitmap Correction'
        OnClick = BitmapCorrection1Click
      end
      object ShowErrorList1: TMenuItem
        Caption = 'Show Error List'
        OnClick = ShowErrorList1Click
      end
      object ShowWarnings1: TMenuItem
        Caption = 'Show Warnings'
        OnClick = ShowWarnings1Click
      end
    end
  end
end

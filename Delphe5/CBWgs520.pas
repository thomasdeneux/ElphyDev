...
{ Name:   CBWGS520.PAS                  }
{                                       }
{ Adaptation de CBW version 5.20        }
{ Gérard Sadoc                          }
...
var
  ...
  cbGetStatus : function(BoardNum:Integer; var Status:SmallInt;
                        ...
                        :Integer; StdCall;
  cbStopBackground : function(BoardNum:Integer;FunctionType:Integer):Integer; StdCall;
  ...
  cbSetTrigger : function(BoardNum:Integer; TrigType:Integer; LowThreshold:Word;
                          HighThreshold:Word):Integer; StdCall;

  cbEnableEvent: function(BoardNum:Integer; EventType:LongInt; EventSize:LongInt;
                          Callback:Pointer; UserData:Pointer):Integer; StdCall;
  cbDisableEvent: function(BoardNum:Integer; EventType:LongInt):Integer; StdCall;


  cbDConfigBit: function(BoardNum , portType, BitNum, Direction:integer): integer;StdCall;
...
begin
  ...
  cbGetStatus:=getProc('cbGetIOStatus');          {Attention 2 noms}
  cbStopBackground:=getProc('cbStopIOBackground');{Attention 2 noms}
  ...
  cbEnableEvent:=getProc('cbEnableEvent');
  cbDisableEvent:=getProc('cbDisableEvent');

  cbDConfigBit:=getProc('cbDConfigBit');

end;

Initialization
AffDebug('Initialization cbwgs520',0);

...
{$IFDEF FPC} {$mode delphi} {$DEFINE AcqElphy2} {$A1} {$Z1} {$ENDIF}
    ...
    procedure proTDBUnic_InitConnection(protocol,host:AnsiString;port:Integer;database,login,password:AnsiString;var pu:typeUO);pascal;
    procedure proTDBUnic_CloseConnection(var pu:typeUO);pascal;
    procedure proTDBUnic_LaunchCommit(var pu:typeUO);pascal;
    function constructAnalysisQuery(analysis_type,condition,order:AnsiString):AnsiString;
    function constructStatistics:AnsiString;
    ...
    procedure proTDBUnic_DefineAnalysisType(id,usecase,path:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_RenameAnalysisType(old_id,new_id:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_RelocateAnalysisType(id,new_path:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_ExplainAnalysisType(id,usecase:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_RemoveAnalysisType(id:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    {shortcuts for Input/Output creation, redefinition and deletion}
    procedure proTDBUnic_DefineInputOutput(analysis_type,name,iotype,iocoding,usecase:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_RemoveInputOutput(analysis_type,name:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_RenameInputOutput(analysis_type,old_name,new_name:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_ExplainInputOutput(analysis_type,name,usecase:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    ...
    procedure proTDBUnic_RemoveAnalysis(id:AnsiString;commit:Boolean;var pu:typeUO);pascal; {tested}
    procedure proTDBUnic_GetAnalyses(analysis_type,condition,order:AnsiString;var resultset:TDBResultSet;var pu:typeUO);pascal;
    procedure proTDBUnic_GetStatistics(var resultset:TDBResultSet;var pu:typeUO);pascal;
    procedure proTDBUnic_GetAnalysesAsObjects(analysis_type,condition,order:AnsiString;var queryset:TDBQuerySet;var pu:typeUO);pascal;

implementation
    uses
        DBCache;

    class function TDBUnic.stmClassName:AnsiString;
        begin
            result:='DBUnic';
        end;
    ...
    {
    function constructAnalysisQuery(analysis_type,condition,order:AnsiString;connection:TDBConnection):AnsiString;
        var
            ioModel:TDBModel;
            ...
            pin:TDBObject;
            i:Integer;
            coding,cls,pinname,pintype,select,from,where,join:AnsiString;
            query:AnsiString;
        ...
        begin
            ...
            for i:=1 to pins.count do
                begin
                    ...
                    if coding = 'str' then cls:='AnsiString';
                    if coding = 'file' then cls:='AnsiString';
    ...
    function constructStatistics:AnsiString;
        var
            ...
            stat_query,tmp_query,null_row:AnsiString;
    ...
    function constructAnalysisQuery(analysis_type,condition,order:AnsiString):AnsiString;
        var
            ...
            analysis_id,analysis_comments,coding,cls,pintype,oldpinname,pinname,select,from,where,join,query,row,values,value,aliases:AnsiString;
    ...
    procedure proTDBUnic_DefineAnalysisType(id,usecase,path:AnsiString;commit:Boolean;var pu:typeUO); {tested}
    ...
    procedure proTDBUnic_RenameAnalysisType(old_id,new_id:AnsiString;commit:Boolean;var pu:typeUO);{tested}
        {Renames the AnsiString that identifies an analysis type :
    ...
    procedure proTDBUnic_RelocateAnalysisType(id,new_path:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_ExplainAnalysisType(id,usecase:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_DefineInputOutput(analysis_type,name,iotype,iocoding,usecase:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_RenameInputOutput(analysis_type,old_name,new_name:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_ExplainInputOutput(analysis_type,name,usecase:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_RemoveInputOutput(analysis_type,name:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_StoreAnalysis(var analysis_object:TDBObject;commit:Boolean;var pu:typeUO);
        {Stores a complete analysis :
            ...
            - analysis_object : the TDBObject that capture all analysis parameters, it must contain these fields :
                ...
                + id : the identification AnsiString of the new analysis
    ...
    procedure proTDBUnic_RemoveAnalysis(id:AnsiString;commit:Boolean;var pu:typeUO);{tested}
    ...
    procedure proTDBUnic_RemoveAnalysisType(id:AnsiString;commit:Boolean;var pu:typeUO);{tested without dependent ios or analyses}
    ...
    procedure proTDBUnic_GetAnalyses(analysis_type,condition,order:AnsiString;var resultset:TDBResultSet;var pu:typeUO);
        var
            query:AnsiString;
            statement:IZStatement;
    ...
    procedure proTDBUnic_GetAnalysesAsObjects(analysis_type,condition,order:AnsiString;var queryset:TDBQuerySet;var pu:typeUO);
        var
            query:AnsiString;
...
Initialization
AffDebug('Initialization DBUnic',0);

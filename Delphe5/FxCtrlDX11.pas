...
begin
  ...
  begin
    ...
    if AnimationON then transformList.DoRenderSurfaceTransforms;        // Applique les transforms sur RenderSurface
...
begin
  ...
  begin
    ...
    tex.CreateFile(stfTex,weff,heff,g_byte);
    rapp:= SkipFactor;
  end
  else
  begin
...
begin
  result:='i= '+Istr1( intG(errorList[n]),7)+'  x= '+Estr1(IntG(errorList[n])*Tbase,10,3);
end;

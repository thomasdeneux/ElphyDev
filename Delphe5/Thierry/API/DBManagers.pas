...
interface
    ...
    type
        ...
        public
            ...
            function get(where:String):TDBObject;
            function all(order:String):TDBQuerySet;
            function filter(where,order:String):TDBQuerySet;
            function search(join,where,order:String):TDBQuerySet;
    ...
    procedure proTDBManager_get(where:String;var dbobject:TDBObject;var pu:typeUO);pascal;
    procedure proTDBManager_all(order:String;var qset:TDBQuerySet;var pu:typeUO);pascal;
    procedure proTDBManager_filter(where,order:String;var qset:TDBQuerySet;var pu:typeUO);pascal;
    procedure proTDBManager_search(join,where,order:String;var qset:TDBQuerySet;var pu:typeUO);pascal;
...
implementation
    ...
    function TDBManager.get(where:String):TDBObject;
        var
    ...
    function TDBManager.all(order:String):TDBQuerySet;
        var
            query:String;
            qset:TDBQuerySet;
    ...
    function TDBManager.filter(where,order:String):TDBQuerySet;
        var
            query:String;
            qset:TDBQuerySet;
    ...
    function TDBManager.search(join,where,order:String):TDBQuerySet;
        var
            query:String;
            qset:TDBQuerySet;
    ...
    function TDBManager.insert(var item:TDBObject;commit:boolean=True;break:boolean=False):TDBObject;{tested}
        var
            ...
            ios:TDBQuerySet;
            query,coding,cls,condition,pinname,pintype:String;
    ...
    class function TDBManager.stmClassName:string;
        begin
            result:='DBManager';
        end;
